...
using DG.Tweening;
public class MergeHuggy1 : Singleton<MergeHuggy1>
{
    ...
    [HideInInspector] public List<CharacterHuggy> lstCharacter = new List<CharacterHuggy>();
    ...
    private void Start()
    {
        ...
        {
            lstCharacter.Add(characterParent.transform.GetChild(i).GetComponent<CharacterHuggy>());
        }
    ...
    IEnumerator IEAfterAttackWin(float time)
    {
        ...
        if (countEnd == 0)
        {
            StartCoroutine(IENextWave2((1.9f)));
        }
    }
    IEnumerator IENextWave2(float time)
    {
        ...
        {
            lstCharacter.Add(characterParent2.transform.GetChild(i).GetComponent<CharacterHuggy>());
        }
