...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    /*AttackUniversal start.*/
    Bridge.define("AttackUniversal", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            AttackPlayerCollision: null,
            radius: 0,
            damage: 0,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "AttackUniversal#init", this ); }

                this.AttackPlayerCollision = new UnityEngine.LayerMask();
                this.radius = 2.0;
                this.damage = 1.0;
            }
        },
        methods: {
            /*AttackUniversal.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "AttackUniversal#Update", this ); }

                this.DetectCollision();
            },
            /*AttackUniversal.Update end.*/

            /*AttackUniversal.DetectCollision start.*/
            DetectCollision: function () {
if ( TRACE ) { TRACE( "AttackUniversal#DetectCollision", this ); }

                var hit = UnityEngine.Physics.OverlapSphere(this.transform.position, this.radius, UnityEngine.LayerMask.op_Implicit(this.AttackPlayerCollision.$clone()));

                if (hit.length > 0) {
                    if (this.isAttackEnemy) {
                        var hitPos = hit[0].transform.position.$clone();
                        hitPos.y += 3;
            ...
            /*AttackUniversal.DetectCollision end.*/
...
if ( TRACE ) { TRACE( "EnemyController#init", this ); }
        ...
        methods: {
            /*EnemyController.AnimationMove start.*/
            AnimationMove: function (temp) {
if ( TRACE ) { TRACE( "EnemyController#AnimationMove", this ); }

                this.animator.SetBool$1(DefineHelper.Moving, temp);
            },
            /*EnemyController.AnimationMove end.*/

            /*EnemyController.AnimationAttack start.*/
            AnimationAttack: function (temp) {
if ( TRACE ) { TRACE( "EnemyController#AnimationAttack", this ); }

                this.animator.SetBool$1(DefineHelper.Attack, temp);
            },
            /*EnemyController.AnimationAttack end.*/

            /*EnemyController.RunToTarget start.*/
            RunToTarget: function () {
if ( TRACE ) { TRACE( "EnemyController#RunToTarget", this ); }

                this.AnimationMove(true);
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, new pc.Vec3( this.transform.position.x, this.transform.position.y, 0.59 ), 1.5), DG.Tweening.Ease.Linear), Bridge.fn.bind(this, function () {
                    this.AnimationMove(false);
                    this.AnimationAttack(true);
                }));
            },
            /*EnemyController.RunToTarget end.*/

            /*EnemyController.ChasingPlayer start.*/
            ChasingPlayer: function () {
if ( TRACE ) { TRACE( "EnemyController#ChasingPlayer", this ); }

                this.isTargetEnemy = true;
                this.playerTarget = Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstCharacter.getItem(UnityEngine.Random.Range(0, Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstCharacter.Count)).gameObject;
            },
            /*EnemyController.ChasingPlayer end.*/
...
if ( TRACE ) { TRACE( "EnemyController#Update", this ); }
                ...
                if (this.isTargetEnemy && this.isAlive) {
                    ...
                    if (pc.Vec3.distance( this.transform.position, this.playerTarget.transform.position ) >= this.minDist) {
                        ...
                        this.transform.position = this.transform.position.$clone().add( this.transform.forward.$clone().clone().scale( this.speedMove ).clone().scale( UnityEngine.Time.deltaTime ) );
                    }
                    if (pc.Vec3.distance( this.transform.position, this.playerTarget.transform.position ) <= this.maxDist) {
                        if (!this.flagAnim2) {
                            this.flagAnim2 = true;
            ...
            /*EnemyController.AnimationDie start.*/
            AnimationDie: function () {
if ( TRACE ) { TRACE( "EnemyController#AnimationDie", this ); }

                this.animator.SetTrigger$1(DefineHelper.Dead);
            },
            /*EnemyController.AnimationDie end.*/

            /*EnemyController.Dying start.*/
            Dying: function () {
if ( TRACE ) { TRACE( "EnemyController#Dying", this ); }
            ...
            /*EnemyController.ApplyDamage start.*/
            ApplyDamage: function () {
if ( TRACE ) { TRACE( "EnemyController#ApplyDamage", this ); }
            ...
            /*EnemyController.ApplyDamage end.*/

            /*EnemyController.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "EnemyController#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag(NameTag.AttackPlayer)) {
                    this.ApplyDamage();
                }
            },
            /*EnemyController.OnTriggerEnter end.*/
...
if ( TRACE ) { TRACE( "CharacterController#init", this ); }
                ...
                this.charScale = new UnityEngine.Vector3();
                this.isAlive = true;
                this.speedMove = 0.9;
                this.maxDist = 1;
                this.minDist = 1;
        ...
        methods: {
            /*CharacterController.ActiveChoose start.*/
            ActiveChoose: function () {
if ( TRACE ) { TRACE( "CharacterController#ActiveChoose", this ); }

                this.border.gameObject.SetActive(true);
                this.circle.gameObject.SetActive(true);
            },
            /*CharacterController.ActiveChoose end.*/

            /*CharacterController.UnActiveChoose start.*/
            UnActiveChoose: function () {
if ( TRACE ) { TRACE( "CharacterController#UnActiveChoose", this ); }

                this.border.gameObject.SetActive(false);
                this.circle.gameObject.SetActive(false);
            },
            /*CharacterController.UnActiveChoose end.*/

            /*CharacterController.SpawnCharacter start.*/
            SpawnCharacter: function (index) {
if ( TRACE ) { TRACE( "CharacterController#SpawnCharacter", this ); }

                var newChar = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.characterUp);
                newChar.transform.position = this.transform.position.$clone();
                newChar.transform.localScale = pc.Vec3.ZERO.clone();
                var newCharacterController = newChar.GetComponent(CharacterController);
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale$1(newChar.transform, newCharacterController.charScale.$clone(), 0.4), DG.Tweening.Ease.OutBack), function () {
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideAttack.SetActive(true);
                    //if (GlobalInstance.Instance.gameManagerInstance.countEnd == 2)
                    //{
                    //    EventDispatcher.Instance.PostEvent(EventID.EndGame);
                    //}
                });
                newCharacterController.txtBorderIndex.text = Bridge.toString(index);
                newCharacterController.txtIndex.text = Bridge.toString(index);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundMerge();
                //For GamePlayFight
                //GlobalInstance.Instance.gameManagerInstance.lstCharacter.Add(newCharacterController);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.enemyMerge = newChar;
                //GlobalInstance.Instance.gameManagerInstance.lstCharacter.Add(newCharacterController);
                this.SpawnerFXSmoke(newChar);
            },
            /*CharacterController.SpawnCharacter end.*/

            /*CharacterController.SpawnerFXSmoke start.*/
            SpawnerFXSmoke: function (parentt) {
if ( TRACE ) { TRACE( "CharacterController#SpawnerFXSmoke", this ); }

                var fx = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.fxSmoke, parentt.transform);
                fx.transform.localPosition = new pc.Vec3( 0, 0.37, 0 );
            },
            /*CharacterController.SpawnerFXSmoke end.*/

            /*CharacterController.RunToTarget start.*/
            RunToTarget: function () {
if ( TRACE ) { TRACE( "CharacterController#RunToTarget", this ); }
            ...
            /*CharacterController.RunToTarget end.*/

            /*CharacterController.ChasingEnemy start.*/
            ChasingEnemy: function () {
if ( TRACE ) { TRACE( "CharacterController#ChasingEnemy", this ); }

                this.isTargetEnemy = true;
                this.enemyTarget = Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.getItem(UnityEngine.Random.Range(0, Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.Count)).gameObject;
            },
            /*CharacterController.ChasingEnemy end.*/
...
if ( TRACE ) { TRACE( "CharacterController#Update", this ); }
                ...
                if (this.isTargetEnemy && this.isAlive) {
                    ...
                    if (pc.Vec3.distance( this.transform.position, this.enemyTarget.transform.position ) <= this.maxDist) {
                        if (!this.flagAnim2) {
                            this.flagAnim2 = true;
                            this.flagAnim1 = false;
                            this.AnimationMove(false);
            ...
            /*CharacterController.AnimationMove start.*/
            AnimationMove: function (temp) {
if ( TRACE ) { TRACE( "CharacterController#AnimationMove", this ); }

                this.animator.SetBool$1(DefineHelper.Moving, temp);
            },
            /*CharacterController.AnimationMove end.*/

            /*CharacterController.AnimationDie start.*/
            AnimationDie: function () {
if ( TRACE ) { TRACE( "CharacterController#AnimationDie", this ); }

                this.animator.SetTrigger$1(DefineHelper.Dead);
            },
            /*CharacterController.AnimationDie end.*/

            /*CharacterController.AnimationAttack start.*/
            AnimationAttack: function (temp) {
if ( TRACE ) { TRACE( "CharacterController#AnimationAttack", this ); }

                this.animator.SetBool$1(DefineHelper.Attack, temp);
            },
            /*CharacterController.AnimationAttack end.*/

            /*CharacterController.Dying start.*/
            Dying: function () {
if ( TRACE ) { TRACE( "CharacterController#Dying", this ); }

                this.isAlive = false;
                this.AnimationDie();
                var random = UnityEngine.Random.Range$1(0.2, 0.45);
                DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, new pc.Vec3( this.transform.position.x, this.yDie, this.transform.position.z - random ), 0.6), 0.4);
            },
            /*CharacterController.Dying end.*/

            /*CharacterController.RotateFacing start.*/
            RotateFacing: function (directionFacing) {
if ( TRACE ) { TRACE( "CharacterController#RotateFacing", this ); }

                if (pc.Vec3.equals( directionFacing, pc.Vec3.ZERO.clone() )) {
                    return;
                }
                var targetRotation = new pc.Quat().setLookAt( directionFacing, pc.Vec3.UP );
                this.transform.rotation = pc.Quat.rotateTowards( this.transform.rotation.$clone(), targetRotation.$clone(), 10 * UnityEngine.Time.deltaTime );
            },
            /*CharacterController.RotateFacing end.*/

            /*CharacterController.ApplyDamage start.*/
            ApplyDamage: function () {
if ( TRACE ) { TRACE( "CharacterController#ApplyDamage", this ); }
            ...
            /*CharacterController.ApplyDamage end.*/

            /*CharacterController.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "CharacterController#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag("AttackEnemy")) {
                    this.ApplyDamage();
                }
            },
            /*CharacterController.OnTriggerEnter end.*/
    ...
    /*CharacterHuggy start.*/
    Bridge.define("CharacterHuggy", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            animator: null,
            circle: null,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#init", this ); }
        ...
        methods: {
            /*CharacterHuggy.ActiveChoose start.*/
            ActiveChoose: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#ActiveChoose", this ); }

                //border.gameObject.SetActive(true);
                this.circle.gameObject.SetActive(true);
            },
            /*CharacterHuggy.ActiveChoose end.*/

            /*CharacterHuggy.UnActiveChoose start.*/
            UnActiveChoose: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#UnActiveChoose", this ); }

                //border.gameObject.SetActive(false);
                this.circle.gameObject.SetActive(false);
            },
            /*CharacterHuggy.UnActiveChoose end.*/

            /*CharacterHuggy.SpawnCharacter start.*/
            SpawnCharacter: function (index) {
if ( TRACE ) { TRACE( "CharacterHuggy#SpawnCharacter", this ); }

                var newChar = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.characterUp);
                newChar.transform.position = this.transform.position.$clone();
                newChar.transform.localScale = pc.Vec3.ZERO.clone();
                var newCharacterController = newChar.GetComponent(MainCharacter);
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale$1(newChar.transform, newCharacterController.charScale.$clone(), 0.4), DG.Tweening.Ease.OutBack), function () {
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideAttack.SetActive(true);
                    //if (GlobalInstance.Instance.gameManagerInstance.countEnd == 2)
                    //{
                ...
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundMerge();
                //For GamePlayFight
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstCharacter.add(newCharacterController);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.enemyMerge = newChar;
                this.SpawnerFXSmoke(newChar);
            },
            /*CharacterHuggy.SpawnCharacter end.*/

            /*CharacterHuggy.SpawnerFXSmoke start.*/
            SpawnerFXSmoke: function (parentt) {
if ( TRACE ) { TRACE( "CharacterHuggy#SpawnerFXSmoke", this ); }

                var fx = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.fxSmoke, parentt.transform);
                fx.transform.localPosition = new pc.Vec3( 0, 0.37, 0 );
            },
            /*CharacterHuggy.SpawnerFXSmoke end.*/

            /*CharacterHuggy.RunToTarget start.*/
            RunToTarget: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#RunToTarget", this ); }
            ...
            /*CharacterHuggy.RunToTarget end.*/

            /*CharacterHuggy.ChasingEnemy start.*/
            ChasingEnemy: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#ChasingEnemy", this ); }

                this.isTargetEnemy = true;
                this.enemyTarget = Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.getItem(UnityEngine.Random.Range(0, Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.Count)).gameObject;
            },
            /*CharacterHuggy.ChasingEnemy end.*/

            /*CharacterHuggy.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#Update", this ); }
            ...
            /*CharacterHuggy.Update end.*/

            /*CharacterHuggy.AnimationMove start.*/
            AnimationMove: function (temp) {
if ( TRACE ) { TRACE( "CharacterHuggy#AnimationMove", this ); }

                this.animator.SetBool$1(DefineHelper.Moving, temp);
            },
            /*CharacterHuggy.AnimationMove end.*/

            /*CharacterHuggy.AnimationDie start.*/
            AnimationDie: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#AnimationDie", this ); }

                this.animator.SetTrigger$1(DefineHelper.Dead);
            },
            /*CharacterHuggy.AnimationDie end.*/

            /*CharacterHuggy.AnimationAttack start.*/
            AnimationAttack: function (temp) {
if ( TRACE ) { TRACE( "CharacterHuggy#AnimationAttack", this ); }

                this.animator.SetBool$1(DefineHelper.Attack, temp);
            },
            /*CharacterHuggy.AnimationAttack end.*/

            /*CharacterHuggy.Dying start.*/
            Dying: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#Dying", this ); }
            ...
            /*CharacterHuggy.Dying end.*/

            /*CharacterHuggy.RotateFacing start.*/
            RotateFacing: function (directionFacing) {
if ( TRACE ) { TRACE( "CharacterHuggy#RotateFacing", this ); }
            ...
            /*CharacterHuggy.RotateFacing end.*/

            /*CharacterHuggy.ApplyDamage start.*/
            ApplyDamage: function () {
if ( TRACE ) { TRACE( "CharacterHuggy#ApplyDamage", this ); }
            ...
            /*CharacterHuggy.ApplyDamage end.*/

            /*CharacterHuggy.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "CharacterHuggy#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag("AttackEnemy")) {
                    this.ApplyDamage();
                }
            },
            /*CharacterHuggy.OnTriggerEnter end.*/
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    Bridge.define("DrawLine", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "DrawLine#init", this ); }
        ...
        methods: {
            ...
            Start: function () {
if ( TRACE ) { TRACE( "DrawLine#Start", this ); }
            ...
            /*DrawLine.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "DrawLine#Update", this ); }

                if (!Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame) {
                    if (Singleton$1(GlobalInstance).Instance.gameManagerInstance.isCanDraw) {
                        if (UnityEngine.Input.GetMouseButtonDown(0)) {
                            this.currentLine = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.linePref, this.transform).GetComponent(UnityEngine.LineRenderer);
                        ...
                        if (UnityEngine.Input.GetMouseButton(0)) {
                            ...
                            if (this.timer <= 0) {
                                this.lstLinePoints.add(this.GetMousePosition());
                    ...
                    if (UnityEngine.Input.GetMouseButtonDown(0)) {
                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.InstallFullGame();
                    }
                }
            },
            /*DrawLine.Update end.*/

            /*DrawLine.GetMousePosition start.*/
            GetMousePosition: function () {
if ( TRACE ) { TRACE( "DrawLine#GetMousePosition", this ); }
            ...
            /*DrawLine.GetMousePosition end.*/

            /*DrawLine.SetLineColor start.*/
            SetLineColor: function (color) {
if ( TRACE ) { TRACE( "DrawLine#SetLineColor", this ); }

                this.currentLine.startColor = color.$clone();
                this.currentLine.endColor = color.$clone();
            },
            /*DrawLine.SetLineColor end.*/

            /*DrawLine.SetLineWidth start.*/
            SetLineWidth: function (width) {
if ( TRACE ) { TRACE( "DrawLine#SetLineWidth", this ); }

                this.currentLine.startWidth = width;
                this.currentLine.endWidth = width;
            },
            /*DrawLine.SetLineWidth end.*/
    ...
    Bridge.define("DrawLineCanvas", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "DrawLineCanvas#init", this ); }

                this.startPosition = new UnityEngine.Vector3();
            }
        },
        methods: {
            /*DrawLineCanvas.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "DrawLineCanvas#Update", this ); }
            ...
            /*DrawLineCanvas.Update end.*/

            /*DrawLineCanvas.GetMousePosition start.*/
            /**
             ...
             */
            GetMousePosition: function () {
if ( TRACE ) { TRACE( "DrawLineCanvas#GetMousePosition", this ); }

                var movePos = { v : new UnityEngine.Vector2() };
                UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(Bridge.as(this.parentCanvas.transform, UnityEngine.RectTransform), UnityEngine.Vector2.FromVector3(UnityEngine.Input.mousePosition), this.parentCanvas.worldCamera, movePos);
                var positionToReturn = this.parentCanvas.transform.TransformPoint$1(UnityEngine.Vector3.FromVector2(movePos.v));
                positionToReturn.z = this.parentCanvas.transform.position.z;
                return positionToReturn.$clone();
            },
            /*DrawLineCanvas.GetMousePosition end.*/

            /*DrawLineCanvas.StartDrawingLine start.*/
            /**
             ...
             * @return  {void}
             */
            StartDrawingLine: function () {
if ( TRACE ) { TRACE( "DrawLineCanvas#StartDrawingLine", this ); }

                this.startPosition = this.GetMousePosition();
                this.currentLineObject = new UnityEngine.GameObject.ctor();
                this.currentLineObject.transform.position = this.startPosition.$clone();
                this.currentLineRenderer = this.currentLineObject.AddComponent(UnityEngine.LineRenderer);
                this.currentLineRenderer.material = this.lineMaterial;
                this.currentLineRenderer.startWidth = this.lineThickness;
                this.currentLineRenderer.endWidth = this.lineThickness;
            },
            /*DrawLineCanvas.StartDrawingLine end.*/

            /*DrawLineCanvas.PreviewLine start.*/
            /**
...
if ( TRACE ) { TRACE( "DrawLineCanvas#PreviewLine", this ); }

                this.currentLineRenderer.SetPositions(System.Array.init([this.startPosition.$clone(), this.GetMousePosition()], UnityEngine.Vector3));
            },
            /*DrawLineCanvas.PreviewLine end.*/

            /*DrawLineCanvas.EndDrawingLine start.*/
            /**
             ...
             * @return  {void}
             */
            EndDrawingLine: function () {
if ( TRACE ) { TRACE( "DrawLineCanvas#EndDrawingLine", this ); }

                this.startPosition = pc.Vec3.ZERO.clone();
                this.currentLineObject = null;
                this.currentLineRenderer = null;
            },
            /*DrawLineCanvas.EndDrawingLine end.*/
...
if ( TRACE ) { TRACE( "HelperUtility#PosHandle", this ); }
    ...
    Bridge.define("MainCharacter", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MainCharacter#init", this ); }
        ...
        methods: {
            /*MainCharacter.ActiveChoose start.*/
            ActiveChoose: function () {
if ( TRACE ) { TRACE( "MainCharacter#ActiveChoose", this ); }

                //border.gameObject.SetActive(true);
                this.circle.gameObject.SetActive(true);
            },
            /*MainCharacter.ActiveChoose end.*/

            /*MainCharacter.UnActiveChoose start.*/
            UnActiveChoose: function () {
if ( TRACE ) { TRACE( "MainCharacter#UnActiveChoose", this ); }

                //border.gameObject.SetActive(false);
                this.circle.gameObject.SetActive(false);
            },
            /*MainCharacter.UnActiveChoose end.*/

            /*MainCharacter.SpawnCharacter start.*/
            SpawnCharacter: function (index) {
if ( TRACE ) { TRACE( "MainCharacter#SpawnCharacter", this ); }
            ...
            /*MainCharacter.SpawnCharacter end.*/

            /*MainCharacter.SpawnerFXSmoke start.*/
            SpawnerFXSmoke: function (parentt) {
if ( TRACE ) { TRACE( "MainCharacter#SpawnerFXSmoke", this ); }

                var fx = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.fxSmoke, parentt.transform);
                fx.transform.localPosition = new pc.Vec3( 0, 0.37, 0 );
            },
            /*MainCharacter.SpawnerFXSmoke end.*/

            /*MainCharacter.ChasingEnemy start.*/
            ChasingEnemy: function () {
if ( TRACE ) { TRACE( "MainCharacter#ChasingEnemy", this ); }

                this.isTargetEnemy = true;
                this.enemyTarget = Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.getItem(UnityEngine.Random.Range(0, Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstEnemy.Count)).gameObject;
            },
            /*MainCharacter.ChasingEnemy end.*/

            /*MainCharacter.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "MainCharacter#Update", this ); }
            ...
            /*MainCharacter.Update end.*/

            /*MainCharacter.AnimationMove start.*/
            AnimationMove: function (temp) {
if ( TRACE ) { TRACE( "MainCharacter#AnimationMove", this ); }

                this.animator.SetBool$1(DefineHelper.Moving, temp);
            },
            /*MainCharacter.AnimationMove end.*/

            /*MainCharacter.AnimationDie start.*/
            AnimationDie: function () {
if ( TRACE ) { TRACE( "MainCharacter#AnimationDie", this ); }

                this.animator.SetTrigger$1(DefineHelper.Dead);
            },
            /*MainCharacter.AnimationDie end.*/

            /*MainCharacter.AnimationAttack start.*/
            AnimationAttack: function (temp) {
if ( TRACE ) { TRACE( "MainCharacter#AnimationAttack", this ); }

                this.animator.SetBool$1(DefineHelper.Attack, temp);
            },
            /*MainCharacter.AnimationAttack end.*/

            /*MainCharacter.Dying start.*/
            Dying: function () {
if ( TRACE ) { TRACE( "MainCharacter#Dying", this ); }
            ...
            /*MainCharacter.Dying end.*/

            /*MainCharacter.RotateFacing start.*/
            RotateFacing: function (directionFacing) {
if ( TRACE ) { TRACE( "MainCharacter#RotateFacing", this ); }
            ...
            /*MainCharacter.RotateFacing end.*/

            /*MainCharacter.ApplyDamage start.*/
            ApplyDamage: function () {
if ( TRACE ) { TRACE( "MainCharacter#ApplyDamage", this ); }
            ...
            /*MainCharacter.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "MainCharacter#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag(NameTag.AttackEnemy)) {
                    this.ApplyDamage();
                }
            },
            /*MainCharacter.OnTriggerEnter end.*/
    ...
    Bridge.define("LookAtCamera", {
        ...
        methods: {
            /*LookAtCamera.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "LookAtCamera#Start", this ); }

                this.camera = Singleton$1(GlobalInstance).Instance.gameManagerInstance.cameraMain.gameObject;
            },
            /*LookAtCamera.Start end.*/

            /*LookAtCamera.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "LookAtCamera#Update", this ); }

                this.transform.LookAt$2(this.transform.position.$clone().add( this.camera.transform.forward ));
            },
...
if ( TRACE ) { TRACE( "RotateObject#Start", this ); }
    ...
    /*ShootingRaycast start.*/
    Bridge.define("ShootingRaycast", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            ray: null,
            lstObjects: null,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "ShootingRaycast#init", this ); }

                this.ray = new UnityEngine.Ray();
                this.lstObjects = new (System.Collections.Generic.List$1(MainCharacter)).ctor();
                this.flagMergeDone = false;
            }
        },
        methods: {
            /*ShootingRaycast.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "ShootingRaycast#Update", this ); }
                            ...
                            if (UnityEngine.Physics.Raycast$1(this.ray, hit, window.Infinity, 512)) {
                                ...
                                if (select.transform.CompareTag(NameTag.Player)) {
                                    ...
                                    if (!charController.isChoosed) {
                                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundChoose();
                                        charController.isChoosed = true;
                                        charController.ActiveChoose();
                                        this.lstObjects.add(charController);
                                    }
                                }
                            }
                        }
                        if (UnityEngine.Input.GetMouseButtonUp(0)) {
                            if (this.lstObjects.Count > 1) {
                                this.StartCoroutine$1(this.IEMergePlayer());
                                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isCanDraw = false;
                                Singleton$1(GlobalInstance).Instance.gameManagerInstance.drawLine.lstLinePoints.clear();
                                UnityEngine.Object.Destroy(Singleton$1(GlobalInstance).Instance.gameManagerInstance.drawLine.currentLine);
                            } else {
                                this.ResetAll();
                            }
                        }
            ...
            /*ShootingRaycast.Update end.*/

            /*ShootingRaycast.IEMergePlayer start.*/
            IEMergePlayer: function () {
if ( TRACE ) { TRACE( "ShootingRaycast#IEMergePlayer", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    //For GamePlayFight
                                        if (this.lstObjects.Count <= ((Bridge.Int.div(Singleton$1(GlobalInstance).Instance.gameManagerInstance.totalPlayer, 2)) | 0)) {
                                            EventDispatcher.Instance.PostEvent(EventID.CheckMerge);
                                        }
                                        lastObject = this.lstObjects.getItem(((this.lstObjects.Count - 1) | 0));
                                        for (var i = 0; i < this.lstObjects.Count; i = (i + 1) | 0) {
                                            this.lstObjects.getItem(i).UnActiveChoose();
                                            //For GamePlayFight
                                            Singleton$1(GlobalInstance).Instance.gameManagerInstance.lstCharacter.remove(this.lstObjects.getItem(i));
                                        }
                                ...
                                case 1: {
                                    for (var i1 = 0; i1 < this.lstObjects.Count; i1 = (i1 + 1) | 0) {
                                            DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.lstObjects.getItem(i1).transform, lastObject.transform.position.$clone(), 0.7), DG.Tweening.Ease.InBack), Bridge.fn.bind(this, function () {
                                                if (!this.flagMergeDone) {
                                                    this.flagMergeDone = true;
                                                    var index = 0;
                                                    for (var j = 0; j < this.lstObjects.Count; j = (j + 1) | 0) {

                                                        index = (index + (Bridge.Int.mul(this.lstObjects.getItem(j).index, 2))) | 0;
                                                        if (j === ((this.lstObjects.Count - 1) | 0)) {
                                                            this.lstObjects.getItem(j).SpawnCharacter(index);
                                                        }
                                                        this.lstObjects.getItem(j).gameObject.SetActive(false);
                                                    }
            ...
            /*ShootingRaycast.IEMergePlayer end.*/

            /*ShootingRaycast.ResetAll start.*/
            ResetAll: function () {
if ( TRACE ) { TRACE( "ShootingRaycast#ResetAll", this ); }

                this.flagMergeDone = false;
                for (var i = 0; i < this.lstObjects.Count; i = (i + 1) | 0) {
                    this.lstObjects.getItem(i).UnActiveChoose();
                    this.lstObjects.getItem(i).isChoosed = false;
                }
                this.lstObjects.clear();
                //GlobalInstance.Instance.gameManagerInstance.isCanDraw = true;
            },
            /*ShootingRaycast.ResetAll end.*/
...
if ( TRACE ) { TRACE( "VectorUlti#ToVectorXZ", this ); }
    ...
    /*Baby start.*/
    Bridge.define("Baby", {
        inherits: [EnemyController],
        fields: {
            prefBullet: null,
            pointShoot: null
        },
        methods: {
            /*Baby.SpawnerBullet start.*/
            SpawnerBullet: function () {
if ( TRACE ) { TRACE( "Baby#SpawnerBullet", this ); }

                if (this.isAlive) {
                    var bullet = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.prefBullet);
                    bullet.transform.position = this.pointShoot.position.$clone();
                    //bullet.transform.rotation = pointShoot.rotation;
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundPunch();
                    bullet.GetComponent(UnityEngine.Rigidbody).AddForce$1(this.pointShoot.transform.forward.clone().scale( 200 ));
                }
            },
            /*Baby.SpawnerBullet end.*/
    ...
    /*BossHuggy start.*/
    Bridge.define("BossHuggy", {
        inherits: [EnemyController],
        fields: {
            colliderAttack: null
        },
        methods: {
            /*BossHuggy.AttackDamage start.*/
            AttackDamage: function () {
if ( TRACE ) { TRACE( "BossHuggy#AttackDamage", this ); }
                ...
                if (this.isAlive) {
                    ...
                    this.colliderAttack.enabled = true;
                    ...
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        ...
                        this.colliderAttack.enabled = false;
                    }), 1));
                }
            },
            /*BossHuggy.AttackDamage end.*/
    ...
    /*BossHuggyNew start.*/
    Bridge.define("BossHuggyNew", {
        inherits: [EnemyController],
        fields: {
            colliderAttack: null
        },
        methods: {
            /*BossHuggyNew.AttackDamage start.*/
            AttackDamage: function () {
if ( TRACE ) { TRACE( "BossHuggyNew#AttackDamage", this ); }
    ...
    /*BunnyBunzoCraft start.*/
    Bridge.define("BunnyBunzoCraft", {
        inherits: [EnemyController],
        fields: {
            prefBullet: null
        },
        methods: {
            /*BunnyBunzoCraft.Attacking start.*/
            Attacking: function () {
if ( TRACE ) { TRACE( "BunnyBunzoCraft#Attacking", this ); }

                if (this.isAlive) {
                    var bullet = SimplePool.Spawn$2(this.prefBullet);
                    bullet.transform.position = this.playerTarget.transform.position.$clone();
                    //bullet.transform.rotation = Quaternion.Euler(90, 0, 0);
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundLightning();
                }
            },
            /*BunnyBunzoCraft.Attacking end.*/
...
if ( TRACE ) { TRACE( "Singleton$1#Instance#get", this ); }
    ...
    Bridge.define("Huggy09", {
        ...
        methods: {
            /*Huggy09.ActiveEffectSlash start.*/
            ActiveEffectSlash: function () {
if ( TRACE ) { TRACE( "Huggy09#ActiveEffectSlash", this ); }

                if (this.isAlive) {
                    this.effectSlash.SetActive(true);
                    this.spikeAttack.SetActive(true);
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundPunch();
                    this.colliderAttack.enabled = true;
                    this.spikeAttack.GetComponent(UnityEngine.ParticleSystem).Play();
                    this.effectSlash.GetComponent(UnityEngine.ParticleSystem).Play();
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        this.effectSlash.SetActive(false);
                        this.spikeAttack.SetActive(false);
                        this.colliderAttack.enabled = false;
                    }), 1));
                }
            },
            /*Huggy09.ActiveEffectSlash end.*/
    ...
    /*HuggyCraft start.*/
    Bridge.define("HuggyCraft", {
        inherits: [MainCharacter],
        fields: {
            colliderAttack: null
        },
        methods: {
            /*HuggyCraft.Attacking start.*/
            Attacking: function () {
if ( TRACE ) { TRACE( "HuggyCraft#Attacking", this ); }
    ...
    Bridge.define("HumanCraft", {
        ...
        methods: {
            /*HumanCraft.Attacking start.*/
            Attacking: function () {
if ( TRACE ) { TRACE( "HumanCraft#Attacking", this ); }
            ...
            /*HumanCraft.Attacking end.*/

            /*HumanCraft.ApplyDamage start.*/
            ApplyDamage: function () {
if ( TRACE ) { TRACE( "HumanCraft#ApplyDamage", this ); }
                ...
                //ChangeColor();
                this.meshRenderer.SetPropertyBlock(this._propBlock);
                this.hand.SetPropertyBlock(this._propBlock);
                this.head.SetPropertyBlock(this._propBlock);
                this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                    this._propBlock.SetColor$1("_Color", UnityEngine.Color32.op_Implicit(new UnityEngine.Color32.$ctor1(217, 217, 217, 255)));
                    this.meshRenderer.SetPropertyBlock(this._propBlock);
                    this.hand.SetPropertyBlock(this._propBlock);
    ...
    /*KillyWillyCraft start.*/
    Bridge.define("KillyWillyCraft", {
        inherits: [EnemyController],
        fields: {
            prefBullet: null
        },
        methods: {
            /*KillyWillyCraft.Attacking start.*/
            Attacking: function () {
if ( TRACE ) { TRACE( "KillyWillyCraft#Attacking", this ); }
...
if ( TRACE ) { TRACE( "GameManager1#Start", this ); }
            ...
            /*GameManager1.LogEndGame start.*/
            LogEndGame: function () {
if ( TRACE ) { TRACE( "GameManager1#LogEndGame", this ); }

                Luna.Unity.LifeCycle.GameEnded();
            },
            /*GameManager1.LogEndGame end.*/
...
if ( TRACE ) { TRACE( "GameManager2#init", this ); }
                ...
                this.lstCharacter = new (System.Collections.Generic.List$1(CharacterController)).ctor();
                this.lstEnemy = new (System.Collections.Generic.List$1(EnemyController)).ctor();
            }
        },
        methods: {
            /*GameManager2.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "GameManager2#OnEnable", this ); }

                EventDispatcher.Instance.RegisterListener(EventID.StartAttack, Bridge.fn.bind(this, function (param) {
                    this.ActionAttack();
                }));
                EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, Bridge.fn.bind(this, function (param) {
                    this.SetMergeLose();
                }));
            },
            /*GameManager2.OnEnable end.*/
...
if ( TRACE ) { TRACE( "GameManager2#Start", this ); }
                ...
                Luna.Unity.LifeCycle.GameStarted();
                this.isCanDraw = true;
                for (var i = 0; i < this.characterParent.transform.childCount; i = (i + 1) | 0) {
                    this.lstCharacter.add(this.characterParent.transform.GetChild(i).GetComponent(CharacterController));
                }
                for (var i1 = 0; i1 < this.enemyParent.transform.childCount; i1 = (i1 + 1) | 0) {
                    this.lstEnemy.add(this.enemyParent.transform.GetChild(i1).GetComponent(EnemyController));
                }
                this.totalPlayer = this.characterParent.transform.childCount;
                this.isMergeWin = true;
            },
            /*GameManager2.Start end.*/

            /*GameManager2.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "GameManager2#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*GameManager2.ActionAllCharacter end.*/

            /*GameManager2.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "GameManager2#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*GameManager2.ActionAllEnemy end.*/

            /*GameManager2.SetMergeLose start.*/
            SetMergeLose: function () {
if ( TRACE ) { TRACE( "GameManager2#SetMergeLose", this ); }

                this.isMergeWin = false;
            },
            /*GameManager2.SetMergeLose end.*/

            /*GameManager2.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "GameManager2#ActionAttack", this ); }

                this.ActionAllCharacter();
                this.ActionAllEnemy();
                this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                    this.soundController.PlaySoundPunch();
                }), 2.1));
                if (this.isMergeWin) {
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                            this.lstEnemy.getItem(i).ApplyDamage();
                        }
                    }), 2.4));
                    this.StartCoroutine$1(this.IEAfterAttackWin(2.8));
                } else {
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                            this.lstCharacter.getItem(i).ApplyDamage();
                        }
                    }), 2.4));
                    this.StartCoroutine$1(this.IEAfterAttackFalse(2.8));
                }
            },
            /*GameManager2.ActionAttack end.*/

            /*GameManager2.IEAfterAttackFalse start.*/
            IEAfterAttackFalse: function (time) {
if ( TRACE ) { TRACE( "GameManager2#IEAfterAttackFalse", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                                            this.lstEnemy.getItem(i).AnimationAttack(false);
                                        }
                                        for (var i1 = 0; i1 < this.lstCharacter.Count; i1 = (i1 + 1) | 0) {
                                            this.lstCharacter.getItem(i1).Dying();
                                        }
                                        DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.lose.transform, 1, 0.8), DG.Tweening.Ease.OutBack);
                                        this.soundController.PlaySoundLose();
                                        this.StartCoroutine$1(this.IEEndCard((2.0)));
            ...
            /*GameManager2.IEAfterAttackFalse end.*/

            /*GameManager2.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "GameManager2#IEAfterAttackWin", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                            this.lstCharacter.getItem(i).AnimationAttack(false);
                                        }
                                        for (var i1 = 0; i1 < this.lstEnemy.Count; i1 = (i1 + 1) | 0) {
                                            this.lstEnemy.getItem(i1).Dying();
                                        }
                                        DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.victory.transform, 1, 0.8), DG.Tweening.Ease.OutBack);
                                        this.soundController.PlaySoundWin();
                                        this.StartCoroutine$1(this.IEEndCard((2.0)));
            ...
            /*GameManager2.IEAfterAttackWin end.*/

            /*GameManager2.IEEndCard start.*/
            IEEndCard: function (time) {
if ( TRACE ) { TRACE( "GameManager2#IEEndCard", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    this.characterParent.SetActive(false);
                                        this.enemyParent.SetActive(false);
                                        this.enemyMerge.SetActive(false);
                                        this.lose.gameObject.SetActive(false);
                                        this.victory.gameObject.SetActive(false);
                                        this.guideEnd.gameObject.SetActive(true);
                                        this.LogEndGame();
                                        this.isReallyEnd = true;
            ...
            /*GameManager2.IEEndCard end.*/

            /*GameManager2.LogEndGame start.*/
            LogEndGame: function () {
if ( TRACE ) { TRACE( "GameManager2#LogEndGame", this ); }

                Luna.Unity.LifeCycle.GameEnded();
            },
            /*GameManager2.LogEndGame end.*/
...
if ( TRACE ) { TRACE( "GameManager2#InstallFullGame", this ); }
    ...
    /*GameManager3 start.*/
    Bridge.define("GameManager3", {
        inherits: function () {
if ( TRACE ) { TRACE( "GameManager3#inherits", this ); }
 return [Singleton$1(GameManager3)]; },
        fields: {
            isCanDraw: false,
            isEndGame: false,
            isReallyEnd: false,
        ...
        methods: {
            /*GameManager3.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "GameManager3#Start", this ); }

                Luna.Unity.LifeCycle.GameStarted();
                this.isCanDraw = true;
            },
            /*GameManager3.Start end.*/

            /*GameManager3.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "GameManager3#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*GameManager3.ToTheEndGame end.*/

            /*GameManager3.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "GameManager3#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*GameManager3.InstallFullGame end.*/
    ...
    /*GameManager4 start.*/
    Bridge.define("GameManager4", {
        inherits: function () {
if ( TRACE ) { TRACE( "GameManager4#inherits", this ); }
 return [Singleton$1(GameManager4)]; },
        fields: {
            isCanDraw: false,
            isEndGame: false,
            cameraMain: null,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "GameManager4#init", this ); }
        ...
        methods: {
            /*GameManager4.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "GameManager4#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                EventDispatcher.Instance.RegisterListener(EventID.EndGame, Bridge.fn.bind(this, function (param) {
                    this.EndCard();
                }));
            },
            /*GameManager4.OnEnable end.*/

            /*GameManager4.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "GameManager4#Start", this ); }

                Luna.Unity.LifeCycle.GameStarted();
                this.fightBtn.onClick.AddListener(Bridge.fn.cacheBind(this, this.ActionAttack));
                this.isCanDraw = true;
                for (var i = 0; i < this.characterParent.transform.childCount; i = (i + 1) | 0) {
                    this.lstCharacter.add(this.characterParent.transform.GetChild(i).GetComponent(CharacterController));
                }
            ...
            /*GameManager4.Start end.*/

            /*GameManager4.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "GameManager4#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*GameManager4.ActionAllCharacter end.*/

            /*GameManager4.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "GameManager4#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*GameManager4.ActionAllEnemy end.*/

            /*GameManager4.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "GameManager4#UnActiveGuide", this ); }
            ...
            /*GameManager4.UnActiveGuide end.*/

            /*GameManager4.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "GameManager4#ActionAttack", this ); }
                ...
                //    }
                //}, 4f));
                this.StartCoroutine$1(this.IEAfterAttackWin(3.4));
                //}
            },
            /*GameManager4.ActionAttack end.*/

            /*GameManager4.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "GameManager4#IEAfterAttackWin", this ); }
                        ...
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                            this.lstCharacter.getItem(i).AnimationAttack(false);
                                            this.lstCharacter.getItem(i).isTargetEnemy = false;
                                        }
                                        for (var i1 = 0; i1 < this.lstEnemy.Count; i1 = (i1 + 1) | 0) {
                                            this.lstEnemy.getItem(i1).Dying();
                                        }
                                        DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOScale(this.victory.transform, 1, 0.8), DG.Tweening.Ease.OutBack);
                                        this.soundController.PlaySoundWin();
                                        this.StartCoroutine$1(this.IENextWave2((2.7)));
            ...
            /*GameManager4.IEAfterAttackWin end.*/

            /*GameManager4.IENextWave2 start.*/
            IENextWave2: function (time) {
if ( TRACE ) { TRACE( "GameManager4#IENextWave2", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                            this.lstCharacter.getItem(i).gameObject.SetActive(false);
                                        }
                                        this.enemyParent.SetActive(false);
                                        this.lose.gameObject.SetActive(false);
                                        this.victory.gameObject.SetActive(false);
                                        ...
                                        this.waveEnd.SetActive(true);
                                        this.isCanDraw = true;
                                        this.countEnd = (this.countEnd + 1) | 0;
            ...
            /*GameManager4.IENextWave2 end.*/

            /*GameManager4.EndCard start.*/
            EndCard: function () {
if ( TRACE ) { TRACE( "GameManager4#EndCard", this ); }

                this.fightBtn.onClick.RemoveListener(Bridge.fn.cacheBind(this, this.ActionAttack));
                this.fightBtn.enabled = false;
                this.guideAttack.SetActive(true);
                this.ToTheEndGame();
            },
            /*GameManager4.EndCard end.*/

            /*GameManager4.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "GameManager4#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*GameManager4.ToTheEndGame end.*/

            /*GameManager4.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "GameManager4#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*GameManager4.InstallFullGame end.*/
    ...
    /*GameManager6 start.*/
    Bridge.define("GameManager6", {
        inherits: function () {
if ( TRACE ) { TRACE( "GameManager6#inherits", this ); }
 return [Singleton$1(GameManager6)]; },
        fields: {
            drawLine: null,
            isCanDraw: false,
            isEndGame: false,
            ...
            totalPlayer: 0,
            enemyMerge: null,
            characterParent2: null,
            enemyParent2: null,
            characterParent3: null,
            enemyParent3: null,
            countEnd: 0,
            victory: null,
            lose: null,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "GameManager6#init", this ); }
        ...
        methods: {
            /*GameManager6.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "GameManager6#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                //EventDispatcher.Instance.RegisterListener(EventID.EndGame, (param) => { EndCard(); });
            },
            /*GameManager6.OnEnable end.*/

            /*GameManager6.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "GameManager6#Start", this ); }
            ...
            /*GameManager6.Start end.*/

            /*GameManager6.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "GameManager6#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*GameManager6.ActionAllCharacter end.*/

            /*GameManager6.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "GameManager6#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*GameManager6.ActionAllEnemy end.*/

            /*GameManager6.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "GameManager6#UnActiveGuide", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guide.SetActive(false);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideHand.SetActive(false);
                //GlobalInstance.Instance.gameManagerInstance.guideHand2.SetActive(false);
            },
            /*GameManager6.UnActiveGuide end.*/

            /*GameManager6.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "GameManager6#ActionAttack", this ); }
            ...
            /*GameManager6.ActionAttack end.*/

            /*GameManager6.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "GameManager6#IEAfterAttackWin", this ); }
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        if (this.countEnd === 0) {
                                            ...
                                            this.StartCoroutine$1(this.IENextWave3((2.7)));
                                        }
            ...
            /*GameManager6.IEAfterAttackWin end.*/

            /*GameManager6.IENextWave2 start.*/
            IENextWave2: function (time) {
if ( TRACE ) { TRACE( "GameManager6#IENextWave2", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        for (var i1 = 0; i1 < this.lstEnemy.Count; i1 = (i1 + 1) | 0) {
                                            this.lstEnemy.getItem(i1).gameObject.SetActive(false);
                                        }
                                        this.lose.gameObject.SetActive(false);
                                        this.victory.gameObject.SetActive(false);
                                        this.guideHand2.SetActive(true);
                                        this.guide.SetActive(true);
                                        this.lstCharacter.clear();
                                        this.lstEnemy.clear();
                                        for (var i2 = 0; i2 < this.characterParent2.transform.childCount; i2 = (i2 + 1) | 0) {
                                            this.lstCharacter.add(this.characterParent2.transform.GetChild(i2).GetComponent(CharacterController));
                                        }
            ...
            /*GameManager6.IENextWave2 end.*/

            /*GameManager6.IENextWave3 start.*/
            IENextWave3: function (time) {
if ( TRACE ) { TRACE( "GameManager6#IENextWave3", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        this.lose.gameObject.SetActive(false);
                                        this.victory.gameObject.SetActive(false);
                                        this.guideHand3.SetActive(true);
                                        this.guide.SetActive(true);
                                        this.lstCharacter.clear();
                                        this.lstEnemy.clear();
                                        for (var i2 = 0; i2 < this.characterParent2.transform.childCount; i2 = (i2 + 1) | 0) {
                                        ...
                                        this.characterParent3.SetActive(true);
                                        this.enemyParent3.SetActive(true);
            ...
            /*GameManager6.IENextWave3 end.*/

            /*GameManager6.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "GameManager6#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*GameManager6.ToTheEndGame end.*/

            /*GameManager6.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "GameManager6#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*GameManager6.InstallFullGame end.*/
...
if ( TRACE ) { TRACE( "GlobalInstance#init", this ); }
                ...
                this.gameManagerInstance = Singleton$1(MergeHuggyCraft1).Instance;
            }
        }
    });
    /*GlobalInstance end.*/
    ...
    /*MergeHuggy1 start.*/
    Bridge.define("MergeHuggy1", {
        inherits: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#inherits", this ); }
 return [Singleton$1(MergeHuggy1)]; },
        fields: {
            drawLine: null,
            isCanDraw: false,
            isEndGame: false,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#init", this ); }

                this.lstCharacter = new (System.Collections.Generic.List$1(CharacterHuggy)).ctor();
                this.lstEnemy = new (System.Collections.Generic.List$1(EnemyController)).ctor();
            }
        },
        methods: {
            /*MergeHuggy1.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                //EventDispatcher.Instance.RegisterListener(EventID.EndGame, (param) => { EndCard(); });
            },
            /*MergeHuggy1.OnEnable end.*/

            /*MergeHuggy1.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#Start", this ); }

                Luna.Unity.LifeCycle.GameStarted();
                this.fightBtn.onClick.AddListener(Bridge.fn.cacheBind(this, this.ActionAttack));
                this.isCanDraw = true;
                for (var i = 0; i < this.characterParent.transform.childCount; i = (i + 1) | 0) {
                    this.lstCharacter.add(this.characterParent.transform.GetChild(i).GetComponent(CharacterHuggy));
                }
                for (var i1 = 0; i1 < this.enemyParent.transform.childCount; i1 = (i1 + 1) | 0) {
                    this.lstEnemy.add(this.enemyParent.transform.GetChild(i1).GetComponent(EnemyController));
                }
            ...
            /*MergeHuggy1.Start end.*/

            /*MergeHuggy1.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*MergeHuggy1.ActionAllCharacter end.*/

            /*MergeHuggy1.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*MergeHuggy1.ActionAllEnemy end.*/

            /*MergeHuggy1.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#UnActiveGuide", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guide.SetActive(false);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideHand.SetActive(false);
                //GlobalInstance.Instance.gameManagerInstance.guideHand2.SetActive(false);
            },
            /*MergeHuggy1.UnActiveGuide end.*/

            /*MergeHuggy1.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#ActionAttack", this ); }
            ...
            /*MergeHuggy1.ActionAttack end.*/

            /*MergeHuggy1.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "MergeHuggy1#IEAfterAttackWin", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        this.soundController.PlaySoundWin();
                                        if (this.countEnd === 0) {
                                            this.StartCoroutine$1(this.IENextWave2((1.9)));
                                        }
            ...
            /*MergeHuggy1.IEAfterAttackWin end.*/

            /*MergeHuggy1.IENextWave2 start.*/
            IENextWave2: function (time) {
if ( TRACE ) { TRACE( "MergeHuggy1#IENextWave2", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        this.lstEnemy.clear();
                                        for (var i2 = 0; i2 < this.characterParent2.transform.childCount; i2 = (i2 + 1) | 0) {
                                            this.lstCharacter.add(this.characterParent2.transform.GetChild(i2).GetComponent(CharacterHuggy));
                                        }
                                        for (var i3 = 0; i3 < this.enemyParent2.transform.childCount; i3 = (i3 + 1) | 0) {
                                            this.lstEnemy.add(this.enemyParent2.transform.GetChild(i3).GetComponent(EnemyController));
                                        }
            ...
            /*MergeHuggy1.IENextWave2 end.*/

            /*MergeHuggy1.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*MergeHuggy1.ToTheEndGame end.*/

            /*MergeHuggy1.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "MergeHuggy1#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*MergeHuggy1.InstallFullGame end.*/
    ...
    Bridge.define("MergeHuggyCraft1", {
        inherits: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#inherits", this ); }
 return [Singleton$1(MergeHuggyCraft1)]; },
        fields: {
            drawLine: null,
            isCanDraw: false,
            isEndGame: false,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#init", this ); }

                this.lstCharacter = new (System.Collections.Generic.List$1(MainCharacter)).ctor();
                this.lstEnemy = new (System.Collections.Generic.List$1(EnemyController)).ctor();
            }
        },
        methods: {
            /*MergeHuggyCraft1.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                //EventDispatcher.Instance.RegisterListener(EventID.EndGame, (param) => { EndCard(); });
                Luna.Unity.LifeCycle.addOnMute(Bridge.fn.cacheBind(this, this.MuteGameFunction));
                Luna.Unity.LifeCycle.addOnUnmute(Bridge.fn.cacheBind(this, this.UnMuteGameFunction));
            },
            /*MergeHuggyCraft1.OnEnable end.*/

            /*MergeHuggyCraft1.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#Start", this ); }

                Luna.Unity.LifeCycle.GameStarted();
                this.fightBtn.onClick.AddListener(Bridge.fn.cacheBind(this, this.ActionAttack));
                this.isCanDraw = true;
                for (var i = 0; i < this.characterParent.transform.childCount; i = (i + 1) | 0) {
                    this.lstCharacter.add(this.characterParent.transform.GetChild(i).GetComponent(MainCharacter));
                }
                for (var i1 = 0; i1 < this.enemyParent.transform.childCount; i1 = (i1 + 1) | 0) {
                    this.lstEnemy.add(this.enemyParent.transform.GetChild(i1).GetComponent(EnemyController));
                }
            ...
            /*MergeHuggyCraft1.Start end.*/

            /*MergeHuggyCraft1.MuteGameFunction start.*/
            MuteGameFunction: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#MuteGameFunction", this ); }

                this.soundController.audioSourceBG.volume = 0;
                this.soundController.audioSourceFX.volume = 0;
            },
            /*MergeHuggyCraft1.MuteGameFunction end.*/

            /*MergeHuggyCraft1.UnMuteGameFunction start.*/
            UnMuteGameFunction: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#UnMuteGameFunction", this ); }

                this.soundController.audioSourceBG.volume = 1;
                this.soundController.audioSourceFX.volume = 1;
            },
            /*MergeHuggyCraft1.UnMuteGameFunction end.*/

            /*MergeHuggyCraft1.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*MergeHuggyCraft1.ActionAllCharacter end.*/

            /*MergeHuggyCraft1.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*MergeHuggyCraft1.ActionAllEnemy end.*/

            /*MergeHuggyCraft1.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#UnActiveGuide", this ); }
            ...
            /*MergeHuggyCraft1.UnActiveGuide end.*/

            /*MergeHuggyCraft1.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#ActionAttack", this ); }
            ...
            /*MergeHuggyCraft1.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#IEAfterAttackWin", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        this.soundController.PlaySoundWin();
                                        if (this.countEnd === 0) {
                                            this.StartCoroutine$1(this.IENextWave2((2.4)));
                                        }
            ...
            /*MergeHuggyCraft1.IEAfterAttackWin end.*/

            /*MergeHuggyCraft1.IENextWave2 start.*/
            IENextWave2: function (time) {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#IENextWave2", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        this.lstEnemy.clear();
                                        for (var i2 = 0; i2 < this.characterParent2.transform.childCount; i2 = (i2 + 1) | 0) {
                                            this.lstCharacter.add(this.characterParent2.transform.GetChild(i2).GetComponent(MainCharacter));
                                        }
                                        for (var i3 = 0; i3 < this.enemyParent2.transform.childCount; i3 = (i3 + 1) | 0) {
                                            this.lstEnemy.add(this.enemyParent2.transform.GetChild(i3).GetComponent(EnemyController));
                                        }
            ...
            /*MergeHuggyCraft1.IENextWave2 end.*/

            /*MergeHuggyCraft1.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*MergeHuggyCraft1.ToTheEndGame end.*/

            /*MergeHuggyCraft1.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "MergeHuggyCraft1#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*MergeHuggyCraft1.InstallFullGame end.*/
    ...
    /*MergeHyper start.*/
    Bridge.define("MergeHyper", {
        inherits: function () {
if ( TRACE ) { TRACE( "MergeHyper#inherits", this ); }
 return [Singleton$1(MergeHyper)]; },
        fields: {
            drawLine: null,
            isCanDraw: false,
            isEndGame: false,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MergeHyper#init", this ); }
        ...
        methods: {
            /*MergeHyper.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "MergeHyper#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                //EventDispatcher.Instance.RegisterListener(EventID.EndGame, (param) => { EndCard(); });
            },
            /*MergeHyper.OnEnable end.*/

            /*MergeHyper.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MergeHyper#Start", this ); }
            ...
            /*MergeHyper.Start end.*/

            /*MergeHyper.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "MergeHyper#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*MergeHyper.ActionAllCharacter end.*/

            /*MergeHyper.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "MergeHyper#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*MergeHyper.ActionAllEnemy end.*/

            /*MergeHyper.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "MergeHyper#UnActiveGuide", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guide.SetActive(false);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideHand.SetActive(false);
                //GlobalInstance.Instance.gameManagerInstance.guideHand2.SetActive(false);
            },
            /*MergeHyper.UnActiveGuide end.*/

            /*MergeHyper.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "MergeHyper#ActionAttack", this ); }
            ...
            /*MergeHyper.ActionAttack end.*/

            /*MergeHyper.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "MergeHyper#IEAfterAttackWin", this ); }
            ...
            /*MergeHyper.IEAfterAttackWin end.*/

            /*MergeHyper.IENextWave2 start.*/
            IENextWave2: function (time) {
if ( TRACE ) { TRACE( "MergeHyper#IENextWave2", this ); }
            ...
            /*MergeHyper.IENextWave2 end.*/

            /*MergeHyper.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "MergeHyper#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*MergeHyper.ToTheEndGame end.*/

            /*MergeHyper.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "MergeHyper#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*MergeHyper.InstallFullGame end.*/
    ...
    /*MergeHyper2 start.*/
    Bridge.define("MergeHyper2", {
        inherits: function () {
if ( TRACE ) { TRACE( "MergeHyper2#inherits", this ); }
 return [Singleton$1(MergeHyper2)]; },
        fields: {
            drawLine: null,
            isCanDraw: false,
            isEndGame: false,
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "MergeHyper2#init", this ); }
        ...
        methods: {
            /*MergeHyper2.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "MergeHyper2#OnEnable", this ); }

                //EventDispatcher.Instance.RegisterListener(EventID.CheckMerge, (param) => { SetMergeLose(); });
                //EventDispatcher.Instance.RegisterListener(EventID.EndGame, (param) => { EndCard(); });
            },
            /*MergeHyper2.OnEnable end.*/

            /*MergeHyper2.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "MergeHyper2#Start", this ); }
            ...
            /*MergeHyper2.Start end.*/

            /*MergeHyper2.ActionAllCharacter start.*/
            ActionAllCharacter: function () {
if ( TRACE ) { TRACE( "MergeHyper2#ActionAllCharacter", this ); }

                for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                    this.lstCharacter.getItem(i).ChasingEnemy();
                }
            },
            /*MergeHyper2.ActionAllCharacter end.*/

            /*MergeHyper2.ActionAllEnemy start.*/
            ActionAllEnemy: function () {
if ( TRACE ) { TRACE( "MergeHyper2#ActionAllEnemy", this ); }

                for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
                    this.lstEnemy.getItem(i).ChasingPlayer();
                }
            },
            /*MergeHyper2.ActionAllEnemy end.*/

            /*MergeHyper2.UnActiveGuide start.*/
            UnActiveGuide: function () {
if ( TRACE ) { TRACE( "MergeHyper2#UnActiveGuide", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guide.SetActive(false);
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideHand.SetActive(false);
            },
            /*MergeHyper2.UnActiveGuide end.*/

            /*MergeHyper2.ActionAttack start.*/
            ActionAttack: function () {
if ( TRACE ) { TRACE( "MergeHyper2#ActionAttack", this ); }
            ...
            /*MergeHyper2.ActionAttack end.*/

            /*MergeHyper2.IEAfterAttackWin start.*/
            IEAfterAttackWin: function (time) {
if ( TRACE ) { TRACE( "MergeHyper2#IEAfterAttackWin", this ); }
                                ...
                                case 1: {
                                    for (var i = 0; i < this.lstCharacter.Count; i = (i + 1) | 0) {
                                        ...
                                        if (this.countEnd === 0) {
                                            ...
                                            this.StartCoroutine$1(this.IENextWaveEnd((2.0)));
            ...
            /*MergeHyper2.IEAfterAttackWin end.*/

            /*MergeHyper2.IENextWaveEnd start.*/
            IENextWaveEnd: function (time) {
if ( TRACE ) { TRACE( "MergeHyper2#IENextWaveEnd", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    this.victory.gameObject.SetActive(false);
                                        ...
                                        this.ToTheEndGame();
                                        this.endGameModel.SetActive(true);
                                        this.guideChooseEnd.SetActive(true);
            ...
            /*MergeHyper2.IENextWaveEnd end.*/

            /*MergeHyper2.ToTheEndGame start.*/
            ToTheEndGame: function () {
if ( TRACE ) { TRACE( "MergeHyper2#ToTheEndGame", this ); }

                Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame = true;
                Luna.Unity.LifeCycle.GameEnded();
            },
            /*MergeHyper2.ToTheEndGame end.*/

            /*MergeHyper2.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "MergeHyper2#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*MergeHyper2.InstallFullGame end.*/
...
if ( TRACE ) { TRACE( "SoundController#inherits", this ); }
 return [Singleton$1(SoundController)]; },
        ...
        methods: {
            /*SoundController.PlaySoundChoose start.*/
            PlaySoundChoose: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundChoose", this ); }

                this.PlaySoundFX(this.clipChoose);
            },
            /*SoundController.PlaySoundChoose end.*/

            /*SoundController.PlaySoundMerge start.*/
            PlaySoundMerge: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundMerge", this ); }

                this.PlaySoundFX(this.clipMerge);
            },
            /*SoundController.PlaySoundMerge end.*/

            /*SoundController.PlaySoundWin start.*/
            PlaySoundWin: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundWin", this ); }

                this.PlaySoundFX(this.clipWin);
            },
            /*SoundController.PlaySoundWin end.*/

            /*SoundController.PlaySoundLose start.*/
            PlaySoundLose: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundLose", this ); }

                this.PlaySoundFX(this.clipLose);
            },
            /*SoundController.PlaySoundLose end.*/

            /*SoundController.PlaySoundPunch start.*/
            PlaySoundPunch: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundPunch", this ); }

                this.PlaySoundFX(this.clipPunch);
            },
            /*SoundController.PlaySoundPunch end.*/

            /*SoundController.PlaySoundLightning start.*/
            PlaySoundLightning: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundLightning", this ); }

                this.PlaySoundFX(this.clipLightning);
            },
            /*SoundController.PlaySoundLightning end.*/

            /*SoundController.PlaySoundFall start.*/
            PlaySoundFall: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundFall", this ); }

                this.PlaySoundFX(this.clipFall);
            },
            /*SoundController.PlaySoundFall end.*/
...
if ( TRACE ) { TRACE( "SoundController#StopSound", this ); }
    ...
    /*AttackUniversal start.*/
    $m("AttackUniversal", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"DetectCollision","t":8,"sn":"DetectCollision","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"AttackPlayerCollision","t":4,"rt":$n[1].LayerMask,"sn":"AttackPlayerCollision"},{"a":2,"n":"damage","t":4,"rt":$n[0].Single,"sn":"damage","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"isAttackEnemy","t":4,"rt":$n[0].Boolean,"sn":"isAttackEnemy","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isAttackPlayer","t":4,"rt":$n[0].Boolean,"sn":"isAttackPlayer","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"radius","t":4,"rt":$n[0].Single,"sn":"radius","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*AttackUniversal end.*/

    /*CharacterController start.*/
    $m("CharacterController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ActiveChoose","t":8,"sn":"ActiveChoose","rt":$n[0].Void},{"a":2,"n":"AnimationAttack","t":8,"pi":[{"n":"temp","pt":$n[0].Boolean,"ps":0}],"sn":"AnimationAttack","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"AnimationDie","t":8,"sn":"AnimationDie","rt":$n[0].Void},{"a":2,"n":"AnimationMove","t":8,"pi":[{"n":"temp","pt":$n[0].Boolean,"ps":0}],"sn":"AnimationMove","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"ApplyDamage","t":8,"sn":"ApplyDamage","rt":$n[0].Void},{"a":2,"n":"ChasingEnemy","t":8,"sn":"ChasingEnemy","rt":$n[0].Void},{"a":2,"n":"Dying","t":8,"sn":"Dying","rt":$n[0].Void},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"RotateFacing","t":8,"pi":[{"n":"directionFacing","pt":$n[1].Vector3,"ps":0}],"sn":"RotateFacing","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":2,"n":"RunToTarget","t":8,"sn":"RunToTarget","rt":$n[0].Void},{"a":2,"n":"SpawnCharacter","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"SpawnCharacter","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"SpawnerFXSmoke","t":8,"pi":[{"n":"parentt","pt":$n[1].GameObject,"ps":0}],"sn":"SpawnerFXSmoke","rt":$n[0].Void,"p":[$n[1].GameObject]},{"a":2,"n":"UnActiveChoose","t":8,"sn":"UnActiveChoose","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"_propBlock","t":4,"rt":$n[1].MaterialPropertyBlock,"sn":"_propBlock"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"animator","t":4,"rt":$n[1].Animator,"sn":"animator"},{"a":2,"n":"border","t":4,"rt":$n[1].GameObject,"sn":"border"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"canvas","t":4,"rt":$n[1].GameObject,"sn":"canvas"},{"a":2,"n":"charScale","t":4,"rt":$n[1].Vector3,"sn":"charScale"},{"a":2,"n":"characterUp","t":4,"rt":$n[1].GameObject,"sn":"characterUp"},{"a":2,"n":"circle","t":4,"rt":$n[1].GameObject,"sn":"circle"},{"a":1,"n":"currentHP","t":4,"rt":$n[0].Int32,"sn":"currentHP","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"enemyTarget","t":4,"rt":$n[1].GameObject,"sn":"enemyTarget"},{"a":1,"n":"flagAnim1","t":4,"rt":$n[0].Boolean,"sn":"flagAnim1","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"flagAnim2","t":4,"rt":$n[0].Boolean,"sn":"flagAnim2","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"fxSmoke","t":4,"rt":$n[1].GameObject,"sn":"fxSmoke"},{"a":1,"n":"hp","t":4,"rt":$n[0].Int32,"sn":"hp","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"index","t":4,"rt":$n[0].Int32,"sn":"index","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"isAlive","t":4,"rt":$n[0].Boolean,"sn":"isAlive","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isChoosed","t":4,"rt":$n[0].Boolean,"sn":"isChoosed","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isTargetEnemy","t":4,"rt":$n[0].Boolean,"sn":"isTargetEnemy","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"maxDist","t":4,"rt":$n[0].Single,"sn":"maxDist","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"meshRenderer","t":4,"rt":$n[1].Renderer,"sn":"meshRenderer"},{"a":1,"n":"minDist","t":4,"rt":$n[0].Single,"sn":"minDist","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"speedMove","t":4,"rt":$n[0].Single,"sn":"speedMove","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("UI")],"a":2,"n":"txtBorderIndex","t":4,"rt":$n[2].Text,"sn":"txtBorderIndex"},{"a":2,"n":"txtIndex","t":4,"rt":$n[2].Text,"sn":"txtIndex"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"yDie","t":4,"rt":$n[0].Single,"sn":"yDie","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*CharacterController end.*/
    ...
    /*Huggy09 start.*/
    $m("Huggy09", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ActiveEffectSlash","t":8,"sn":"ActiveEffectSlash","rt":$n[0].Void},{"a":2,"n":"colliderAttack","t":4,"rt":$n[1].BoxCollider,"sn":"colliderAttack"},{"a":2,"n":"effectSlash","t":4,"rt":$n[1].GameObject,"sn":"effectSlash"},{"a":2,"n":"spikeAttack","t":4,"rt":$n[1].GameObject,"sn":"spikeAttack"}]}; }, $n);
    /*Huggy09 end.*/
    ...
    /*LookAtCamera start.*/
    $m("LookAtCamera", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"camera","t":4,"rt":$n[1].GameObject,"sn":"camera"}]}; }, $n);
    /*LookAtCamera end.*/

    /*ShootingRaycast start.*/
    $m("ShootingRaycast", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"IEMergePlayer","t":8,"sn":"IEMergePlayer","rt":$n[4].IEnumerator},{"a":1,"n":"ResetAll","t":8,"sn":"ResetAll","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"flagMergeDone","t":4,"rt":$n[0].Boolean,"sn":"flagMergeDone","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"lstObjects","t":4,"rt":$n[3].List$1(MainCharacter),"sn":"lstObjects"},{"a":1,"n":"ray","t":4,"rt":$n[1].Ray,"sn":"ray"}]}; }, $n);
    /*ShootingRaycast end.*/

    /*SoundController start.*/
    $m("SoundController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"PlaySoundBG","t":8,"sn":"PlaySoundBG","rt":$n[0].Void},{"a":2,"n":"PlaySoundChoose","t":8,"sn":"PlaySoundChoose","rt":$n[0].Void},{"a":1,"n":"PlaySoundFX","t":8,"pi":[{"n":"audioClip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySoundFX","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":2,"n":"PlaySoundFall","t":8,"sn":"PlaySoundFall","rt":$n[0].Void},{"a":2,"n":"PlaySoundLightning","t":8,"sn":"PlaySoundLightning","rt":$n[0].Void},{"a":2,"n":"PlaySoundLose","t":8,"sn":"PlaySoundLose","rt":$n[0].Void},{"a":2,"n":"PlaySoundMerge","t":8,"sn":"PlaySoundMerge","rt":$n[0].Void},{"a":2,"n":"PlaySoundPunch","t":8,"sn":"PlaySoundPunch","rt":$n[0].Void},{"a":2,"n":"PlaySoundWin","t":8,"sn":"PlaySoundWin","rt":$n[0].Void},{"a":2,"n":"StopSound","t":8,"sn":"StopSound","rt":$n[0].Void},{"a":2,"n":"audioSourceBG","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceBG"},{"a":2,"n":"audioSourceFX","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceFX"},{"a":2,"n":"clipChoose","t":4,"rt":$n[1].AudioClip,"sn":"clipChoose"},{"a":2,"n":"clipFall","t":4,"rt":$n[1].AudioClip,"sn":"clipFall"},{"a":2,"n":"clipLightning","t":4,"rt":$n[1].AudioClip,"sn":"clipLightning"},{"a":2,"n":"clipLose","t":4,"rt":$n[1].AudioClip,"sn":"clipLose"},{"a":2,"n":"clipMerge","t":4,"rt":$n[1].AudioClip,"sn":"clipMerge"},{"a":2,"n":"clipPunch","t":4,"rt":$n[1].AudioClip,"sn":"clipPunch"},{"a":2,"n":"clipWin","t":4,"rt":$n[1].AudioClip,"sn":"clipWin"}]}; }, $n);
    /*SoundController end.*/

    /*GameManager1 start.*/
    $m("GameManager1", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":2,"n":"LogEndGame","t":8,"sn":"LogEndGame","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideEnd","t":4,"rt":$n[1].GameObject,"sn":"guideEnd"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"}]}; }, $n);
    /*GameManager1 end.*/

    /*GameManager2 start.*/
    $m("GameManager2", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":2,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackFalse","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackFalse","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IEEndCard","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEEndCard","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":2,"n":"LogEndGame","t":8,"sn":"LogEndGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"SetMergeLose","t":8,"sn":"SetMergeLose","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"a":2,"n":"endCard","t":4,"rt":$n[1].GameObject,"sn":"endCard"},{"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideEnd","t":4,"rt":$n[1].GameObject,"sn":"guideEnd"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isReallyEnd","t":4,"rt":$n[0].Boolean,"sn":"isReallyEnd","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"}]}; }, $n);
    /*GameManager2 end.*/

    /*GameManager3 start.*/
    $m("GameManager3", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideEnd","t":4,"rt":$n[1].GameObject,"sn":"guideEnd"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isReallyEnd","t":4,"rt":$n[0].Boolean,"sn":"isReallyEnd","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"}]}; }, $n);
    /*GameManager3 end.*/

    /*GameManager4 start.*/
    $m("GameManager4", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":1,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"EndCard","t":8,"sn":"EndCard","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWave2","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWave2","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"a":2,"n":"UnActiveGuide","t":8,"sn":"UnActiveGuide","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"a":2,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"a":2,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"countEnd","t":4,"rt":$n[0].Int32,"sn":"countEnd","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"a":2,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"fightBtn","t":4,"rt":$n[2].Button,"sn":"fightBtn"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideAttack","t":4,"rt":$n[1].GameObject,"sn":"guideAttack"},{"a":2,"n":"guideHand","t":4,"rt":$n[1].GameObject,"sn":"guideHand"},{"a":2,"n":"guideHand2","t":4,"rt":$n[1].GameObject,"sn":"guideHand2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"},{"a":2,"n":"waveEnd","t":4,"rt":$n[1].GameObject,"sn":"waveEnd"}]}; }, $n);
    /*GameManager4 end.*/

    /*GameManager6 start.*/
    $m("GameManager6", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":1,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWave2","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWave2","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWave3","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWave3","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"a":2,"n":"UnActiveGuide","t":8,"sn":"UnActiveGuide","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"a":2,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"a":2,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"a":2,"n":"characterParent2","t":4,"rt":$n[1].GameObject,"sn":"characterParent2"},{"a":2,"n":"characterParent3","t":4,"rt":$n[1].GameObject,"sn":"characterParent3"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"countEnd","t":4,"rt":$n[0].Int32,"sn":"countEnd","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"drawLine","t":4,"rt":DrawLine,"sn":"drawLine"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"a":2,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"enemyParent2","t":4,"rt":$n[1].GameObject,"sn":"enemyParent2"},{"a":2,"n":"enemyParent3","t":4,"rt":$n[1].GameObject,"sn":"enemyParent3"},{"a":2,"n":"fightBtn","t":4,"rt":$n[2].Button,"sn":"fightBtn"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideAttack","t":4,"rt":$n[1].GameObject,"sn":"guideAttack"},{"a":2,"n":"guideHand","t":4,"rt":$n[1].GameObject,"sn":"guideHand"},{"a":2,"n":"guideHand2","t":4,"rt":$n[1].GameObject,"sn":"guideHand2"},{"a":2,"n":"guideHand3","t":4,"rt":$n[1].GameObject,"sn":"guideHand3"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"}]}; }, $n);
    /*GameManager6 end.*/
    ...
    /*NameTag start.*/
    $m("NameTag", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AttackEnemy","is":true,"t":4,"rt":$n[0].String,"sn":"AttackEnemy"},{"a":2,"n":"AttackPlayer","is":true,"t":4,"rt":$n[0].String,"sn":"AttackPlayer"},{"a":2,"n":"Enemy","is":true,"t":4,"rt":$n[0].String,"sn":"Enemy"},{"a":2,"n":"FakeGround","is":true,"t":4,"rt":$n[0].String,"sn":"FakeGround"},{"a":2,"n":"Player","is":true,"t":4,"rt":$n[0].String,"sn":"Player"}]}; }, $n);
    /*NameTag end.*/
    ...
    /*GlobalInstance start.*/
    $m("GlobalInstance", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"gameManagerInstance","t":4,"rt":MergeHuggyCraft1,"sn":"gameManagerInstance"}]}; }, $n);
    /*GlobalInstance end.*/

    /*HelperUtility start.*/
    $m("HelperUtility", function () { return {"nested":[Function],"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOLocalRotateQuaternion","is":true,"t":8,"pi":[{"n":"endValue","pt":$n[1].Quaternion,"ps":0},{"n":"speedRotate","pt":$n[0].Single,"ps":1},{"n":"objLookAt","pt":$n[1].GameObject,"ps":2},{"n":"actionComplete","pt":Function,"ps":3}],"sn":"DOLocalRotateQuaternion","rt":$n[4].IEnumerator,"p":[$n[1].Quaternion,$n[0].Single,$n[1].GameObject,Function]},{"a":2,"n":"DecimalRounding","is":true,"t":8,"pi":[{"n":"Num","pt":$n[0].Single,"ps":0},{"n":"Round","pt":$n[0].Int32,"ps":1}],"sn":"DecimalRounding","rt":$n[0].Single,"p":[$n[0].Single,$n[0].Int32],"box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"DisruptiveArrayObject","is":true,"t":8,"pi":[{"n":"array","pt":System.Array.type(System.Object),"ps":0}],"tpc":1,"tprm":["T"],"sn":"DisruptiveArrayObject","rt":System.Array.type(System.Object),"p":[System.Array.type(System.Object)]},{"a":2,"n":"DisruptiveList","is":true,"t":8,"pi":[{"n":"array","pt":$n[3].List$1(System.Object),"ps":0}],"tpc":1,"tprm":["T"],"sn":"DisruptiveList","rt":$n[3].List$1(System.Object),"p":[$n[3].List$1(System.Object)]},{"a":2,"n":"DisruptiveListObject","is":true,"t":8,"pi":[{"n":"array","pt":$n[3].List$1(System.Object),"ps":0}],"sn":"DisruptiveListObject$1","rt":$n[3].List$1(System.Object),"p":[$n[3].List$1(System.Object)]},{"a":2,"n":"DisruptiveListObject","is":true,"t":8,"pi":[{"n":"array","pt":$n[3].List$1(System.Object),"ps":0}],"tpc":1,"tprm":["T"],"sn":"DisruptiveListObject","rt":$n[3].List$1(System.Object),"p":[$n[3].List$1(System.Object)]},{"a":2,"n":"DisruptiveListSelf","is":true,"t":8,"pi":[{"n":"array","pt":$n[3].List$1(System.Object),"ps":0}],"tpc":1,"tprm":["T"],"sn":"DisruptiveListSelf","rt":$n[3].List$1(System.Object),"p":[$n[3].List$1(System.Object)]},{"a":2,"n":"GetDirectionFromAngle","is":true,"t":8,"pi":[{"n":"vectorP","pt":$n[1].Vector3,"ps":0},{"n":"angle","pt":$n[0].Single,"ps":1},{"n":"positionStart","pt":$n[1].Vector3,"ps":2}],"sn":"GetDirectionFromAngle","rt":$n[1].Vector3,"p":[$n[1].Vector3,$n[0].Single,$n[1].Vector3]},{"a":2,"n":"GetDirectionFromAngle_2","is":true,"t":8,"pi":[{"n":"vectorP","pt":$n[1].Vector3,"ps":0},{"n":"angle","pt":$n[0].Single,"ps":1},{"n":"positionStart","pt":$n[1].Vector3,"ps":2}],"sn":"GetDirectionFromAngle_2","rt":$n[1].Vector3,"p":[$n[1].Vector3,$n[0].Single,$n[1].Vector3]},{"a":2,"n":"GetPointDistanceFromObject","is":true,"t":8,"pi":[{"n":"distance","pt":$n[0].Single,"ps":0},{"n":"direction","pt":$n[1].Vector3,"ps":1},{"n":"fromPoint","pt":$n[1].Vector3,"ps":2}],"sn":"GetPointDistanceFromObject","rt":$n[1].Vector3,"p":[$n[0].Single,$n[1].Vector3,$n[1].Vector3]},{"a":2,"n":"GetRotateDirection","is":true,"t":8,"pi":[{"n":"from","pt":$n[1].Quaternion,"ps":0},{"n":"to","pt":$n[1].Quaternion,"ps":1}],"sn":"GetRotateDirection","rt":$n[0].Boolean,"p":[$n[1].Quaternion,$n[1].Quaternion],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"LookAtToDirection","is":true,"t":8,"pi":[{"n":"diretion","pt":$n[1].Vector3,"ps":0},{"n":"objLookAt","pt":$n[1].GameObject,"ps":1},{"n":"speedLockAt","dv":500.0,"o":true,"pt":$n[0].Single,"ps":2}],"sn":"LookAtToDirection","rt":$n[0].Void,"p":[$n[1].Vector3,$n[1].GameObject,$n[0].Single]},{"a":2,"n":"LookAtToDirectionAngleDetal","is":true,"t":8,"pi":[{"n":"diretion","pt":$n[1].Vector3,"ps":0},{"n":"objLookAt","pt":$n[1].GameObject,"ps":1},{"n":"AngleDetal","pt":$n[0].Single,"ps":2},{"n":"speedLockAt","dv":500.0,"o":true,"pt":$n[0].Single,"ps":3}],"sn":"LookAtToDirectionAngleDetal","rt":$n[0].Void,"p":[$n[1].Vector3,$n[1].GameObject,$n[0].Single,$n[0].Single]},{"a":2,"n":"LookAtToPosition","is":true,"t":8,"pi":[{"n":"position","pt":$n[1].Vector3,"ps":0},{"n":"objLookAt","pt":$n[1].GameObject,"ps":1},{"n":"speedRotate","dv":500.0,"o":true,"pt":$n[0].Single,"ps":2}],"sn":"LookAtToPosition","rt":$n[0].Void,"p":[$n[1].Vector3,$n[1].GameObject,$n[0].Single]},{"a":2,"n":"LookAtToPositionAngleDetal","is":true,"t":8,"pi":[{"n":"position","pt":$n[1].Vector3,"ps":0},{"n":"objLookAt","pt":$n[1].GameObject,"ps":1},{"n":"AngleDetal","pt":$n[0].Single,"ps":2},{"n":"speedRotate","dv":500.0,"o":true,"pt":$n[0].Single,"ps":3}],"sn":"LookAtToPositionAngleDetal","rt":$n[0].Void,"p":[$n[1].Vector3,$n[1].GameObject,$n[0].Single,$n[0].Single]},{"a":1,"n":"PosHandle","is":true,"t":8,"pi":[{"n":"numCount","pt":$n[0].Int32,"ps":0},{"n":"MaxERow","pt":$n[0].Int32,"ps":1}],"sn":"PosHandle","rt":$n[3].List$1(System.Int32),"p":[$n[0].Int32,$n[0].Int32]},{"a":2,"n":"RandomCustom","is":true,"t":8,"pi":[{"n":"first","pt":$n[0].Int32,"ps":0},{"n":"last","pt":$n[0].Int32,"ps":1},{"n":"diff","pt":$n[3].List$1(System.Int32),"ps":2}],"sn":"RandomCustom","rt":$n[0].Int32,"p":[$n[0].Int32,$n[0].Int32,$n[3].List$1(System.Int32)],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"RandomUnduplicated","is":true,"t":8,"pi":[{"n":"diff","pt":$n[3].List$1(System.Int32),"ps":0},{"n":"oldValues","ip":true,"pt":$n[0].Array.type(System.Int32),"ps":1}],"sn":"RandomUnduplicated","rt":$n[0].Int32,"p":[$n[3].List$1(System.Int32),$n[0].Array.type(System.Int32)],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"RandomUnduplicated","is":true,"t":8,"pi":[{"n":"oldValue","pt":$n[0].Int32,"ps":0},{"n":"diff","pt":$n[3].List$1(System.Int32),"ps":1}],"sn":"RandomUnduplicated$1","rt":$n[0].Int32,"p":[$n[0].Int32,$n[3].List$1(System.Int32)],"box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"SelectionSortList","is":true,"t":8,"pi":[{"n":"A","pt":$n[3].List$1(System.Object),"ps":0},{"n":"compareElementList","pt":Function,"ps":1}],"sn":"SelectionSortList","rt":$n[3].List$1(System.Object),"p":[$n[3].List$1(System.Object),Function]},{"a":2,"n":"SetPos","is":true,"t":8,"pi":[{"n":"numCount","pt":$n[0].Int32,"ps":0},{"n":"MaxERow","pt":$n[0].Int32,"ps":1}],"sn":"SetPos","rt":$n[3].List$1(System.Int32),"p":[$n[0].Int32,$n[0].Int32]},{"a":2,"n":"StartAction","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"condition","pt":Function,"ps":1}],"sn":"StartAction","rt":$n[4].IEnumerator,"p":[Function,Function]},{"a":2,"n":"StartAction","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"time","pt":$n[0].Single,"ps":1}],"sn":"StartAction$1","rt":$n[4].IEnumerator,"p":[Function,$n[0].Single]},{"a":2,"n":"StartActionNotUseCorutines","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"time","pt":$n[0].Single,"ps":1}],"sn":"StartActionNotUseCorutines","rt":$n[0].Void,"p":[Function,$n[0].Single]},{"a":2,"n":"StartActionRealTime","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"time","pt":$n[0].Single,"ps":1}],"sn":"StartActionRealTime","rt":$n[4].IEnumerator,"p":[Function,$n[0].Single]},{"a":2,"n":"StartThread","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"timeToStop","pt":$n[0].Single,"ps":1},{"n":"actionStop","dv":null,"o":true,"pt":Function,"ps":2}],"sn":"StartThread$1","rt":$n[4].IEnumerator,"p":[Function,$n[0].Single,Function]},{"a":2,"n":"StartThread","is":true,"t":8,"pi":[{"n":"action","pt":Function,"ps":0},{"n":"conditionStop","pt":Function,"ps":1},{"n":"actionStop","dv":null,"o":true,"pt":Function,"ps":2},{"n":"time","dv":0.01,"o":true,"pt":$n[0].Single,"ps":3}],"sn":"StartThread","rt":$n[4].IEnumerator,"p":[Function,Function,Function,$n[0].Single]}]}; }, $n);
    /*HelperUtility end.*/
    ...
    /*BossHuggy start.*/
    $m("BossHuggy", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AttackDamage","t":8,"sn":"AttackDamage","rt":$n[0].Void},{"a":2,"n":"colliderAttack","t":4,"rt":$n[1].BoxCollider,"sn":"colliderAttack"}]}; }, $n);
    /*BossHuggy end.*/

    /*MergeHyper start.*/
    $m("MergeHyper", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":1,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWave2","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWave2","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"a":2,"n":"UnActiveGuide","t":8,"sn":"UnActiveGuide","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"a":2,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"a":2,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"a":2,"n":"characterParent2","t":4,"rt":$n[1].GameObject,"sn":"characterParent2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"countEnd","t":4,"rt":$n[0].Int32,"sn":"countEnd","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"drawLine","t":4,"rt":DrawLine,"sn":"drawLine"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"a":2,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"enemyParent2","t":4,"rt":$n[1].GameObject,"sn":"enemyParent2"},{"a":2,"n":"fightBtn","t":4,"rt":$n[2].Button,"sn":"fightBtn"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideAttack","t":4,"rt":$n[1].GameObject,"sn":"guideAttack"},{"a":2,"n":"guideHand","t":4,"rt":$n[1].GameObject,"sn":"guideHand"},{"a":2,"n":"guideHand2","t":4,"rt":$n[1].GameObject,"sn":"guideHand2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"}]}; }, $n);
    /*MergeHyper end.*/

    /*MergeHyper2 start.*/
    $m("MergeHyper2", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":1,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWaveEnd","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWaveEnd","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"a":2,"n":"UnActiveGuide","t":8,"sn":"UnActiveGuide","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"a":2,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"a":2,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"countEnd","t":4,"rt":$n[0].Int32,"sn":"countEnd","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"drawLine","t":4,"rt":DrawLine,"sn":"drawLine"},{"a":2,"n":"endGameModel","t":4,"rt":$n[1].GameObject,"sn":"endGameModel"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"a":2,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"fightBtn","t":4,"rt":$n[2].Button,"sn":"fightBtn"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideAttack","t":4,"rt":$n[1].GameObject,"sn":"guideAttack"},{"a":2,"n":"guideChooseEnd","t":4,"rt":$n[1].GameObject,"sn":"guideChooseEnd"},{"a":2,"n":"guideHand","t":4,"rt":$n[1].GameObject,"sn":"guideHand"},{"a":2,"n":"guideHand2","t":4,"rt":$n[1].GameObject,"sn":"guideHand2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"}]}; }, $n);
    /*MergeHyper2 end.*/

    /*BossHuggyNew start.*/
    $m("BossHuggyNew", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"AttackDamage","t":8,"sn":"AttackDamage","rt":$n[0].Void},{"a":2,"n":"colliderAttack","t":4,"rt":$n[1].BoxCollider,"sn":"colliderAttack"}]}; }, $n);
    /*BossHuggyNew end.*/

    /*CharacterHuggy start.*/
    $m("CharacterHuggy", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ActiveChoose","t":8,"sn":"ActiveChoose","rt":$n[0].Void},{"a":2,"n":"AnimationAttack","t":8,"pi":[{"n":"temp","pt":$n[0].Boolean,"ps":0}],"sn":"AnimationAttack","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"AnimationDie","t":8,"sn":"AnimationDie","rt":$n[0].Void},{"a":2,"n":"AnimationMove","t":8,"pi":[{"n":"temp","pt":$n[0].Boolean,"ps":0}],"sn":"AnimationMove","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"ApplyDamage","t":8,"sn":"ApplyDamage","rt":$n[0].Void},{"a":2,"n":"ChasingEnemy","t":8,"sn":"ChasingEnemy","rt":$n[0].Void},{"a":2,"n":"Dying","t":8,"sn":"Dying","rt":$n[0].Void},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"RotateFacing","t":8,"pi":[{"n":"directionFacing","pt":$n[1].Vector3,"ps":0}],"sn":"RotateFacing","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":2,"n":"RunToTarget","t":8,"sn":"RunToTarget","rt":$n[0].Void},{"a":2,"n":"SpawnCharacter","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"SpawnCharacter","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"SpawnerFXSmoke","t":8,"pi":[{"n":"parentt","pt":$n[1].GameObject,"ps":0}],"sn":"SpawnerFXSmoke","rt":$n[0].Void,"p":[$n[1].GameObject]},{"a":2,"n":"UnActiveChoose","t":8,"sn":"UnActiveChoose","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"_propBlock","t":4,"rt":$n[1].MaterialPropertyBlock,"sn":"_propBlock"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"animator","t":4,"rt":$n[1].Animator,"sn":"animator"},{"a":2,"n":"charScale","t":4,"rt":$n[1].Vector3,"sn":"charScale"},{"a":2,"n":"characterUp","t":4,"rt":$n[1].GameObject,"sn":"characterUp"},{"a":2,"n":"circle","t":4,"rt":$n[1].GameObject,"sn":"circle"},{"a":1,"n":"currentHP","t":4,"rt":$n[0].Int32,"sn":"currentHP","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"enemyTarget","t":4,"rt":$n[1].GameObject,"sn":"enemyTarget"},{"a":1,"n":"flagAnim1","t":4,"rt":$n[0].Boolean,"sn":"flagAnim1","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"flagAnim2","t":4,"rt":$n[0].Boolean,"sn":"flagAnim2","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"fxSmoke","t":4,"rt":$n[1].GameObject,"sn":"fxSmoke"},{"a":1,"n":"hp","t":4,"rt":$n[0].Int32,"sn":"hp","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"index","t":4,"rt":$n[0].Int32,"sn":"index","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"isAlive","t":4,"rt":$n[0].Boolean,"sn":"isAlive","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HeaderAttribute("UI"),new UnityEngine.HideInInspector()],"a":2,"n":"isChoosed","t":4,"rt":$n[0].Boolean,"sn":"isChoosed","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isTargetEnemy","t":4,"rt":$n[0].Boolean,"sn":"isTargetEnemy","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"maxDist","t":4,"rt":$n[0].Single,"sn":"maxDist","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"meshRenderer","t":4,"rt":$n[1].Renderer,"sn":"meshRenderer"},{"a":1,"n":"minDist","t":4,"rt":$n[0].Single,"sn":"minDist","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"speedMove","t":4,"rt":$n[0].Single,"sn":"speedMove","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*CharacterHuggy end.*/

    /*MergeHuggy1 start.*/
    $m("MergeHuggy1", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"ActionAllCharacter","t":8,"sn":"ActionAllCharacter","rt":$n[0].Void},{"a":1,"n":"ActionAllEnemy","t":8,"sn":"ActionAllEnemy","rt":$n[0].Void},{"a":2,"n":"ActionAttack","t":8,"sn":"ActionAttack","rt":$n[0].Void},{"a":1,"n":"IEAfterAttackWin","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IEAfterAttackWin","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":1,"n":"IENextWave2","t":8,"pi":[{"n":"time","pt":$n[0].Single,"ps":0}],"sn":"IENextWave2","rt":$n[4].IEnumerator,"p":[$n[0].Single]},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ToTheEndGame","t":8,"sn":"ToTheEndGame","rt":$n[0].Void},{"a":2,"n":"UnActiveGuide","t":8,"sn":"UnActiveGuide","rt":$n[0].Void},{"a":2,"n":"arrPosFighting","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"arrPosFighting"},{"a":2,"n":"cameraMain","t":4,"rt":$n[1].Camera,"sn":"cameraMain"},{"a":2,"n":"characterParent","t":4,"rt":$n[1].GameObject,"sn":"characterParent"},{"a":2,"n":"characterParent2","t":4,"rt":$n[1].GameObject,"sn":"characterParent2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"countEnd","t":4,"rt":$n[0].Int32,"sn":"countEnd","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"drawLine","t":4,"rt":DrawLine,"sn":"drawLine"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"enemyMerge","t":4,"rt":$n[1].GameObject,"sn":"enemyMerge"},{"a":2,"n":"enemyParent","t":4,"rt":$n[1].GameObject,"sn":"enemyParent"},{"a":2,"n":"enemyParent2","t":4,"rt":$n[1].GameObject,"sn":"enemyParent2"},{"a":2,"n":"fightBtn","t":4,"rt":$n[2].Button,"sn":"fightBtn"},{"a":2,"n":"guide","t":4,"rt":$n[1].GameObject,"sn":"guide"},{"a":2,"n":"guideAttack","t":4,"rt":$n[1].GameObject,"sn":"guideAttack"},{"a":2,"n":"guideHand","t":4,"rt":$n[1].GameObject,"sn":"guideHand"},{"a":2,"n":"guideHand2","t":4,"rt":$n[1].GameObject,"sn":"guideHand2"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isCanDraw","t":4,"rt":$n[0].Boolean,"sn":"isCanDraw","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"isMergeWin","t":4,"rt":$n[0].Boolean,"sn":"isMergeWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lose","t":4,"rt":$n[2].Image,"sn":"lose"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstCharacter","t":4,"rt":$n[3].List$1(CharacterHuggy),"sn":"lstCharacter"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"lstEnemy","t":4,"rt":$n[3].List$1(EnemyController),"sn":"lstEnemy"},{"a":2,"n":"soundController","t":4,"rt":SoundController,"sn":"soundController"},{"at":[new UnityEngine.HideInInspector()],"a":2,"n":"totalPlayer","t":4,"rt":$n[0].Int32,"sn":"totalPlayer","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("UIConfig")],"a":2,"n":"victory","t":4,"rt":$n[2].Image,"sn":"victory"}]}; }, $n);
    /*MergeHuggy1 end.*/

    /*BunnyBunzoCraft start.*/
    $m("BunnyBunzoCraft", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Attacking","t":8,"sn":"Attacking","rt":$n[0].Void},{"a":2,"n":"prefBullet","t":4,"rt":$n[1].GameObject,"sn":"prefBullet"}]}; }, $n);
    /*BunnyBunzoCraft end.*/

    /*HuggyCraft start.*/
    $m("HuggyCraft", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Attacking","t":8,"sn":"Attacking","rt":$n[0].Void},{"a":2,"n":"colliderAttack","t":4,"rt":$n[1].BoxCollider,"sn":"colliderAttack"}]}; }, $n);
    /*HuggyCraft end.*/

    /*HumanCraft start.*/
    $m("HumanCraft", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"ov":true,"a":2,"n":"ApplyDamage","t":8,"sn":"ApplyDamage","rt":$n[0].Void},{"a":2,"n":"Attacking","t":8,"sn":"Attacking","rt":$n[0].Void},{"a":2,"n":"colliderAttack","t":4,"rt":$n[1].BoxCollider,"sn":"colliderAttack"},{"a":2,"n":"hand","t":4,"rt":$n[1].Renderer,"sn":"hand"},{"a":2,"n":"head","t":4,"rt":$n[1].Renderer,"sn":"head"}]}; }, $n);
    /*HumanCraft end.*/

    /*KillyWillyCraft start.*/
    $m("KillyWillyCraft", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Attacking","t":8,"sn":"Attacking","rt":$n[0].Void},{"a":2,"n":"prefBullet","t":4,"rt":$n[1].GameObject,"sn":"prefBullet"}]}; }, $n);
    /*KillyWillyCraft end.*/
    ...
    /*PEButtonScript start.*/
    $m("PEButtonScript", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"OnButtonClicked","t":8,"sn":"OnButtonClicked","rt":$n[0].Void},{"a":2,"n":"OnPointerEnter","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnPointerEnter","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":2,"n":"OnPointerExit","t":8,"pi":[{"n":"eventData","pt":$n[5].PointerEventData,"ps":0}],"sn":"OnPointerExit","rt":$n[0].Void,"p":[$n[5].PointerEventData]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"ButtonType","t":4,"rt":ButtonTypes,"sn":"ButtonType","box":function ($v) { return Bridge.box($v, ButtonTypes, System.Enum.toStringFn(ButtonTypes));}},{"a":1,"n":"myButton","t":4,"rt":$n[2].Button,"sn":"myButton"}]}; }, $n);
    /*PEButtonScript end.*/
    ...
    /*EpicToonFX.ETFXTarget start.*/
    $m("EpicToonFX.ETFXTarget", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"col","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"Respawn","t":8,"sn":"Respawn","rt":$n[4].IEnumerator},{"a":1,"n":"SpawnTarget","t":8,"sn":"SpawnTarget","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.HeaderAttribute("Effect shown on target hit")],"a":2,"n":"hitParticle","t":4,"rt":$n[1].GameObject,"sn":"hitParticle"},{"at":[new UnityEngine.HeaderAttribute("Effect shown on target respawn")],"a":2,"n":"respawnParticle","t":4,"rt":$n[1].GameObject,"sn":"respawnParticle"},{"a":1,"n":"targetCollider","t":4,"rt":$n[1].Collider,"sn":"targetCollider"},{"a":1,"n":"targetRenderer","t":4,"rt":$n[1].Renderer,"sn":"targetRenderer"}]}; }, $n);
    /*EpicToonFX.ETFXTarget end.*/
    ...
    /*EpicToonFX.ETFXRotation start.*/
    $m("EpicToonFX.ETFXRotation", function () { return {"nested":[$n[12].ETFXRotation.spaceEnum],"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"rotateSpace","t":4,"rt":$n[12].ETFXRotation.spaceEnum,"sn":"rotateSpace","box":function ($v) { return Bridge.box($v, EpicToonFX.ETFXRotation.spaceEnum, System.Enum.toStringFn(EpicToonFX.ETFXRotation.spaceEnum));}},{"at":[new UnityEngine.HeaderAttribute("Rotate axises by degrees per second")],"a":2,"n":"rotateVector","t":4,"rt":$n[1].Vector3,"sn":"rotateVector"}]}; }, $n);
    /*EpicToonFX.ETFXRotation end.*/

    /*EpicToonFX.ETFXRotation+spaceEnum start.*/
    $m("EpicToonFX.ETFXRotation.spaceEnum", function () { return {"td":$n[12].ETFXRotation,"att":258,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Local","is":true,"t":4,"rt":$n[12].ETFXRotation.spaceEnum,"sn":"Local","box":function ($v) { return Bridge.box($v, EpicToonFX.ETFXRotation.spaceEnum, System.Enum.toStringFn(EpicToonFX.ETFXRotation.spaceEnum));}},{"a":2,"n":"World","is":true,"t":4,"rt":$n[12].ETFXRotation.spaceEnum,"sn":"World","box":function ($v) { return Bridge.box($v, EpicToonFX.ETFXRotation.spaceEnum, System.Enum.toStringFn(EpicToonFX.ETFXRotation.spaceEnum));}}]}; }, $n);
    /*EpicToonFX.ETFXRotation+spaceEnum end.*/
