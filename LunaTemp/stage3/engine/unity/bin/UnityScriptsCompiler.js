...
if ( TRACE ) { TRACE( "CharacterController#RunToTarget", this ); }
                ...
                var isFullSlot = true;
                var array = Singleton$1(GlobalInstance).Instance.gameManagerInstance.arrPosFighting;
                ...
                if (!isFullSlot) {
                    ...
                    var posMove = array[random].position.$clone();
                    this.AnimationMove(true);
                    DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, posMove.$clone(), 1.5), DG.Tweening.Ease.Linear), Bridge.fn.bind(this, function () {
                        this.AnimationMove(false);
                        this.animator.SetTrigger$1(DefineHelper.Attack);
                    }));
                    ...
                    var randomPosX = UnityEngine.Random.Range$1(-1.07, 1.07);
                    var posMove1 = new pc.Vec3( randomPosX, 0.079, 0.285 );
                    this.AnimationMove(true);
                    DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, posMove1.$clone(), 1.5), DG.Tweening.Ease.Linear), Bridge.fn.bind(this, function () {
                        this.AnimationMove(false);
                        this.AnimationAttack(true);
...
if ( TRACE ) { TRACE( "ShootingRaycast#init", this ); }
                ...
                this.lstObjects = new (System.Collections.Generic.List$1(CharacterController)).ctor();
                        ...
                        if (UnityEngine.Input.GetMouseButton(0)) {
                            ...
                            if (UnityEngine.Physics.Raycast$1(this.ray, hit, window.Infinity, 512)) {
                                ...
                                if (select.transform.CompareTag(NameTag.Player)) {
                                    var charController = select.GetComponent(CharacterController);
...
if ( TRACE ) { TRACE( "Baby#SpawnerBullet", this ); }
                ...
                if (this.isAlive) {
                    ...
                    bullet.transform.rotation = this.pointShoot.rotation.$clone();
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundTRex();
...
if ( TRACE ) { TRACE( "Huggy09#ActiveEffectSlash", this ); }
                ...
                if (this.isAlive) {
                    ...
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundSlash();
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.soundController.PlaySoundPunch();
                    this.colliderAttack.enabled = true;
...
if ( TRACE ) { TRACE( "GameManager2#ActionAttack", this ); }
                ...
                this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                    ...
                    this.soundController.PlaySoundTRex();
                }), 2.1));
                if (this.isMergeWin) {
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        for (var i = 0; i < this.lstEnemy.Count; i = (i + 1) | 0) {
...
if ( TRACE ) { TRACE( "GameManager4#UnActiveGuide", this ); }
                ...
                Singleton$1(GlobalInstance).Instance.gameManagerInstance.guideHand2.SetActive(false);
            },
...
if ( TRACE ) { TRACE( "GlobalInstance#init", this ); }
                ...
                this.gameManagerInstance = Singleton$1(MergeHyper).Instance;
            }
        }
    });
    /*GlobalInstance end.*/
...
if ( TRACE ) { TRACE( "SoundController#PlaySoundPunch", this ); }
            ...
            /*SoundController.PlaySoundSlash start.*/
            PlaySoundSlash: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundSlash", this ); }

                this.PlaySoundFX(this.clipSlash);
            },
            /*SoundController.PlaySoundSlash end.*/

            /*SoundController.PlaySoundTRex start.*/
            PlaySoundTRex: function () {
if ( TRACE ) { TRACE( "SoundController#PlaySoundTRex", this ); }

                this.PlaySoundFX(this.clipTRex);
            },
            /*SoundController.PlaySoundTRex end.*/
...
if ( TRACE ) { TRACE( "SoundController#StopSound", this ); }
    ...
    /*ShootingRaycast start.*/
    $m("ShootingRaycast", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"IEMergePlayer","t":8,"sn":"IEMergePlayer","rt":$n[4].IEnumerator},{"a":1,"n":"ResetAll","t":8,"sn":"ResetAll","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"flagMergeDone","t":4,"rt":$n[0].Boolean,"sn":"flagMergeDone","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"lstObjects","t":4,"rt":$n[3].List$1(CharacterController),"sn":"lstObjects"},{"a":1,"n":"ray","t":4,"rt":$n[1].Ray,"sn":"ray"}]}; }, $n);
    /*ShootingRaycast end.*/

    /*SoundController start.*/
    $m("SoundController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"PlaySoundBG","t":8,"sn":"PlaySoundBG","rt":$n[0].Void},{"a":2,"n":"PlaySoundChoose","t":8,"sn":"PlaySoundChoose","rt":$n[0].Void},{"a":1,"n":"PlaySoundFX","t":8,"pi":[{"n":"audioClip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySoundFX","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":2,"n":"PlaySoundFall","t":8,"sn":"PlaySoundFall","rt":$n[0].Void},{"a":2,"n":"PlaySoundLose","t":8,"sn":"PlaySoundLose","rt":$n[0].Void},{"a":2,"n":"PlaySoundMerge","t":8,"sn":"PlaySoundMerge","rt":$n[0].Void},{"a":2,"n":"PlaySoundPunch","t":8,"sn":"PlaySoundPunch","rt":$n[0].Void},{"a":2,"n":"PlaySoundSlash","t":8,"sn":"PlaySoundSlash","rt":$n[0].Void},{"a":2,"n":"PlaySoundTRex","t":8,"sn":"PlaySoundTRex","rt":$n[0].Void},{"a":2,"n":"PlaySoundWin","t":8,"sn":"PlaySoundWin","rt":$n[0].Void},{"a":2,"n":"StopSound","t":8,"sn":"StopSound","rt":$n[0].Void},{"a":2,"n":"audioSourceBG","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceBG"},{"a":2,"n":"audioSourceFX","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceFX"},{"a":2,"n":"clipChoose","t":4,"rt":$n[1].AudioClip,"sn":"clipChoose"},{"a":2,"n":"clipFall","t":4,"rt":$n[1].AudioClip,"sn":"clipFall"},{"a":2,"n":"clipLose","t":4,"rt":$n[1].AudioClip,"sn":"clipLose"},{"a":2,"n":"clipMerge","t":4,"rt":$n[1].AudioClip,"sn":"clipMerge"},{"a":2,"n":"clipPunch","t":4,"rt":$n[1].AudioClip,"sn":"clipPunch"},{"a":2,"n":"clipSlash","t":4,"rt":$n[1].AudioClip,"sn":"clipSlash"},{"a":2,"n":"clipTRex","t":4,"rt":$n[1].AudioClip,"sn":"clipTRex"},{"a":2,"n":"clipWin","t":4,"rt":$n[1].AudioClip,"sn":"clipWin"}]}; }, $n);
    /*SoundController end.*/
    ...
    /*GlobalInstance start.*/
    $m("GlobalInstance", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"gameManagerInstance","t":4,"rt":MergeHyper,"sn":"gameManagerInstance"}]}; }, $n);
    /*GlobalInstance end.*/
